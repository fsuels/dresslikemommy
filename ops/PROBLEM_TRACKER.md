...
| `PROB-2026-05-14-PAID-LANDING-VENDOR-SOURCE-URL-LEAK` | `P1` | `LOCAL_FIX_READY__LIVE_SYNC_REQUIRED` | Codex current session / next Shopify theme operator | Active GB/CA/AU exact Search landing PDP and theme vendor/brand analytics attributes | Get fresh explicit approval for scoped live theme sync/push of the vendor/source sanitizer files, then repeat public source/DOM readback on GB/CA/AU final URLs. Do not edit Shopify product/vendor data under paid-growth guardrails unless separately approved | Live paid landing source and rendered DOM show `0` supplier/source-domain hits for `detail.1688.com`, `1688.com`, `alibaba.com`, and `aliexpress.com`, and no `data-analytics-vendor="https://` or `data-item-brand="https://`; analytics payload brand fields are sanitized | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-marketing-command-layer-live-reconciliation/paid-landing-source-url-sanitizer/LOCAL_PAID_LANDING_VENDOR_SOURCE_URL_FIX_REPORT.md` |
...
| `PROB-2026-05-12-ACTIVE-CAMPAIGN-COVERAGE-GOAL` | `P0` | `GB_CA_AU_LIVE_HOLD__PINTEREST_AUTH_BLOCKED__MERCHANT_CAPACITY_VISIBLE` | Parent/orchestrator / next activation operator | Owner goal: working active Google Ads and Pinterest campaigns for every viable language/market | 2026-05-14 read-only reconciliation: GB/CA/AU exact Search remain enabled/eligible at the approved scope with `$0.00` cost, `0` clicks, `0` impressions, and `0.00` conversions/value for `2026-05-13`; GB search terms are readable but empty, CA/AU are blocked by stale `Keyword: "human hair wigs"` filters. Standard Shopping is enabled/eligible with `17` impressions, `0` clicks, `$0.00` cost, `0.00` conversions/value. Pinterest remains unauthenticated in controllable browser. Merchant now shows a live Shopping ads capacity prioritized fix and US/es age_group is sample-cleared but exact-current-export pending. | Google Ads and Pinterest have active, measured, read-back-clean campaigns for every owner-approved viable language/market, or each excluded market has an explicit owner decision and evidence-backed reason | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-marketing-command-layer-live-reconciliation/LIVE_RECONCILIATION_REPORT.md`, prior planning evidence under `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-gb-ca-au-monitoring/` and `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-paid-growth-sales-moving-continuation/` |
...
- Priority: `P1`
- Status: `LOCAL_FIX_READY__LIVE_SYNC_REQUIRED`
...
Current next action:
- Monitor GB/CA/AU again after reporting populates; 2026-05-14 says hold/no-write for all three. GB search terms are readable but empty; CA/AU remain non-actionable until the stale `Keyword: "human hair wigs"` filter is absent or explicitly cleared in a read-only reporting context. Pinterest remains blocked by authenticated controllable Ads Manager access; ES/IT Golden Daisy remains native-signoff and exact-approval gated.
