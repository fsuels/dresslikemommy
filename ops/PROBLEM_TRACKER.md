...
- Priority: `P1`
- Status: `PATH_B_GROUPED_FEEDS_GENERATED__LIVE_UPSTREAM_GUARD_FAIL_EXPECTED`
- Owner/session: Codex automation current session, 2026-05-15 10:07 EDT / next paid-growth + Shopify channel operator.
...
- Apply the Shopify Pinterest channel grouping toggle if exposed. If not exposed, use the generated `feeds/pinterest_<market>.tsv` Path B files only after a separate exact upload/import approval.
