...
|---|---|---|---|---|---|---|---|
| `PROB-2026-05-09-NON-US-SEARCH-TEST-BUILD-GATE` | `P1` | `PARTIAL_12_APPLIED_RO_BROWSER_FILE_PICKER_BLOCKED_PT_GR_ABSENT_FR_STALE_BE_LAST` | Codex parent/orchestrator current session / next Google Ads operator | Approved paused non-US Google Search build; `GB`, `CA`, `AU`, `CH`, `DK`, `DE`, `NL`, `SE`, `ES`, `IT`, `PL`, and `CZ` are created paused and read back clean; `RO` remains absent; `PT`, `GR`, `FR`, and `BE` remain uncreated/blocked | Do not re-upload completed countries and do not stack `PT`/`GR` behind unresolved `RO`. Next unblock is a file-picker-capable authenticated Google Ads browser session or Google Ads Editor path to preview only `RO_intl_search_paused_draft_web_bulk.csv`, then read back before any apply. `FR` still needs a fresh non-stale preview/no-duplicate readback; `BE` remains last after the RO path is clear | Completed countries remain paused/presence-only; remaining approved paused campaigns are either built with clean before/after evidence and no live spend, or safely parked with exact unblock action | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-controlled-measurement-pinterest-build/CONTROLLED_MEASUREMENT_PINTEREST_BUILD_REPORT.md`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-controlled-measurement-pinterest-build/raw/google_ads_bulk_upload_readonly_probe.json`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-10-google-ads-non-us-search-paused-test-build-approved/working/google_ads_split_bulk_apply_state.json`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-10-paid-growth-cz-ro-pt-gr-paused-search-build/PAID_GROWTH_CZ_RO_PT_GR_PAUSED_SEARCH_BUILD_REPORT.md` |
...
| `PROB-2026-05-12-ACTIVE-CAMPAIGN-COVERAGE-GOAL` | `P0` | `GB_CA_AU_EXACT_SEARCH_LIVE_INNER_ENTITIES_ENABLED__OPTIMIZATION_AND_NEXT_MARKETS_ACTIVE` | Parent/orchestrator / next activation operator | Owner goal: working active Google Ads and Pinterest campaigns for every viable language/market | GB/CA/AU first English exact Search cohort is now enabled through campaign, exact ad group, 3 exact keywords, and 1 RSA per market. URLs were prechecked for English plus GB/GBP, CA/CAD, and AU/AUD presentment. Entity-page UI shows exact keywords Enabled/Eligible and RSAs Eligible; campaign overview still showed stale `All keywords are paused` immediately after enablement, so next monitor must confirm serving-status refresh. Next work is expert optimization: search-term monitoring, country-specific negatives, ad strength/asset strategy, and controlled next-market expansion under exact approvals. Restore authenticated Pinterest Ads Manager access for the already-approved paused US draft. Continue RO/PT/GR/FR/BE paused build only after the RO file-picker path is available | Google Ads and Pinterest have active, measured, read-back-clean campaigns for every owner-approved viable language/market, or each excluded market has an explicit owner decision and evidence-backed reason | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-gb-ca-au-inner-enable-live/GB_CA_AU_INNER_ENABLE_EXECUTION_REPORT.md`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-gb-ca-au-inner-enable-live/raw/post-enable-readback/final_success_summary.json`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-gb-ca-au-inner-enable-live/raw/post-inner-ui-entity-pages/`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-gb-ca-au-monitoring/GB_CA_AU_IMMEDIATE_MONITORING_REPORT.md`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-ca-au-enable-live/CA_AU_ENABLE_EXECUTION_REPORT.md`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-google-ads-non-us-first-enable-gb-live/FIRST_ENABLE_GB_EXECUTION_REPORT.md` |
...
Status: `GB_CA_AU_EXACT_SEARCH_LIVE_INNER_ENTITIES_ENABLED__OPTIMIZATION_AND_NEXT_MARKETS_ACTIVE`
...
Current next action:
- Monitor GB/CA/AU again after Ads UI/status propagation; confirm campaign overview no longer reports stale paused-inner-entity reason, then watch early impressions/clicks/cost/search terms.
- Build and, with fresh exact approval, apply country-specific negative additions from evidence. Do not blindly clone one negative list into every language or market after expansion.
...
Status: `PARTIAL_12_APPLIED_RO_BROWSER_FILE_PICKER_BLOCKED_PT_GR_ABSENT_FR_STALE_BE_LAST`
...
Status: `OWNER_ASSUMES_TAGS_CORRECT__PAUSED_US_DRAFT_APPROVED_BUT_AUTH_SESSION_BLOCKED`
