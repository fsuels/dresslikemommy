...
| `PROB-2026-05-14-MERCHANT-SHOPPING-ADS-CAPACITY` | `P1` | `ACTIVE_DIAGNOSE_READONLY__AUTOMATION_CAPABILITY_MISMATCH` | Codex current session / next Merchant growth agent | Merchant Center `124884876`; Shopping ads capacity / paid-cohort serving impact | Keep the blocker active. The warning is current and account-level, but Standard Shopping still served `17` impressions yesterday, so exact impact on the live `780`-row `us_test_ready` / `paid_eligible` cohort remains unproven. Next step is an authenticated read-only Merchant product-level intersection. Do not remove products, alter feeds/sources/product scope, or request capacity without owner decision | Impact is proven irrelevant to active paid cohort/Standard Shopping, or a precise owner-approved capacity/product-scope action clears the serving blocker with before/after readbacks | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-capability-merchant-capacity-diagnosis/AUTOMATION_CAPABILITY_AND_MERCHANT_CAPACITY_DIAGNOSIS.md` |
| `PROB-2026-05-14-PAID-LANDING-VENDOR-SOURCE-URL-LEAK` | `P1` | `SOLVED_FOR_CURRENT_PDP_PUBLIC_SOURCE_READBACK__COLLECTION_ROUTES_SEPARATE` | Codex current session / next Shopify theme operator | Active GB/CA/AU exact Search landing PDP and theme vendor/brand analytics attributes | No further action for the current active PDP final URL unless a future readback regresses. Proceed only to authenticated `$0.15` CPC validation for clean-route rows; keep collection-route blockers tracked separately | Live paid landing source shows `0` supplier/source-domain hits for `detail.1688.com`, `1688.com`, `alibaba.com`, and `aliexpress.com`, and no `data-analytics-vendor="https://` or `data-item-brand="https://` across GB/CA/AU and two header/cache variants | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-paid-landing-post-sanitizer-readback/PAID_LANDING_POST_SANITIZER_AND_COLLECTION_PREFLIGHT.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-marketing-command-layer-live-reconciliation/paid-landing-source-url-sanitizer/LOCAL_PAID_LANDING_VENDOR_SOURCE_URL_FIX_REPORT.md` |
| `PROB-2026-05-14-CANDIDATE-COLLECTION-LANDING-CLEANLINESS` | `P1` | `GBCA_AU_AUTH_CPC_PENDING__US_ROUTE_REROUTE_DONE_LOCAL` | Codex automation current session / next Google Ads operator with landing-CRO support | GB/CA/AU and US keyword-universe collection routes for future long-tail Search/Shopping rows | Validate `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-36-row-cpc-canonical-url-packet/gb_ca_au_36_clean_route_cpc_validation_rows_canonical_urls.csv` in authenticated Google Ads/Keyword Planner at max `$0.15`, then run the patched `validate_keyword_planner_forecast_export.py`; future US Search rows can use the rerouted clean routes only after active-product proof and authenticated `$0.15` CPC/search feasibility; keep original dirty routes excluded until owner-approved product/vendor source cleanup passes public readback. | Every candidate route used for paid traffic returns `200`, has no supplier/source-domain hits, no URL-like analytics brand values, no stale seasonal mismatch, has country/shipping/readback proof, uses canonical final URLs where redirects were found, and passes authenticated `$0.15` CPC/auction validation before upload | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-keyword-route-unblock/US_KEYWORD_ROUTE_UNBLOCK_PACKET.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-current-p0-blocker-fix/P0_BLOCKER_FIX_READBACK.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-collection-source-cleanup-approval/COLLECTION_SOURCE_CLEANUP_APPROVAL_PACKET.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-cpc-validation-decision-kit/GB_CA_AU_CPC_VALIDATION_DECISION_KIT.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-36-row-cpc-canonical-url-packet/GB_CA_AU_36_ROW_CPC_CANONICAL_URL_PACKET.md`; `ops/marketing/keyword_universe.csv` |
| `PROB-2026-05-14-US-SHOPPING-QUERY-TITLE-FIT` | `P1` | `AUTH_EXPORT_JOIN_PREP_READY__AUTH_EXPORT_REQUIRED` | Codex automation current session / next Google Ads + Merchant operator | US Standard Shopping campaign `23802638621`; item-level title/query/product-fit proof | Run authenticated read-only product-item export for campaign `23802638621` with item ID, title, product group/custom label, impressions, clicks, cost, query where available, conversion value, and landing URL or product handle; then run `run_us_shopping_auth_export_join_prep.py --export-csv /path/to/authenticated-export.csv`; keep held repair rows excluded unless repaired/read back clean, the swim-trunks local theme fix is approved/live-synced/read back clean, or the weak-fit row is proven relevant by item-level export | Item-level Shopping export proves titles/product fit either match query demand or identifies exact mismatches for a narrow owner-approved title/feed/public-landing repair packet; no negative/product-group/bid/status action from zero-click zero-cost terms or public PDP hypotheses alone | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-query-title-diagnosis/US_STANDARD_SHOPPING_QUERY_TITLE_DIAGNOSIS.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-public-pdp-fit-preflight/US_SHOPPING_PUBLIC_PDP_FIT_PREFLIGHT.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-held-pdp-repair-packet/US_SHOPPING_HELD_PDP_REPAIR_PACKET.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-seasonal-related-filter/US_SHOPPING_SEASONAL_RELATED_FILTER_LOCAL_FIX.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-seasonal-live-sync-approval/US_SHOPPING_SEASONAL_RELATED_FILTER_LIVE_SYNC_APPROVAL_PACKET.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-auth-export-join-prep/US_SHOPPING_AUTH_EXPORT_JOIN_PREP.md` |
| `PROB-2026-05-08-PINTEREST-EVENT-QUALITY` | `P1` | `ACCESS_RESTORED_DRAFT_CHECK_DONE__PAUSED_SPEC_READY` | Next Pinterest/growth agent | Pinterest advertiser `549756244483`; event quality and campaign readiness | Owner approved the paused US catalog/retargeting draft build using the clean `342`-row scope and `4` exclusions. Do not loop on Event Quality/tag proof. Authenticated controllable Ads Manager access is read back for advertiser `549756244483`; existing-draft sheet has no saved drafts, so next UI step is `Create new campaign` only through the paused spec and stop conditions | Owner-approved paused draft proceeds from clean scope with no live spend, or live activation remains separately gated with documented tag/Event Quality assumption | `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-current-p0-blocker-fix/PINTEREST_EXISTING_DRAFT_CHECK.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-paid-growth-sales-moving-continuation/PINTEREST_US_PAUSED_DRAFT_BUILD_SPEC.md`; `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-12-paid-growth-sales-moving-continuation/pinterest_us_paused_draft_build_spec_validation_summary.json` |
...
- Priority: `P1`
- Status: `GBCA_AU_AUTH_CPC_PENDING__US_ROUTE_REROUTE_DONE_LOCAL`
- Owner/session: Codex automation current session, 2026-05-14 11:59-15:59 EDT / next Google Ads operator with landing-CRO support
...
- Validate `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-36-row-cpc-canonical-url-packet/gb_ca_au_36_clean_route_cpc_validation_rows_canonical_urls.csv` in authenticated Google Ads/Keyword Planner at max `$0.15` CPC, export the forecast/readback rows, and run `python3.13 dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-cpc-validation-decision-kit/validate_keyword_planner_forecast_export.py --forecast-csv /path/to/authenticated-forecast-export.csv`.
- For future US Search, build a small validation packet only after active-product fit and `$0.15` CPC/search feasibility are proved; start from the rerouted clean-route rows in `ops/marketing/keyword_universe.csv`, not the original dirty routes.
...
- Priority: `P1`
- Status: `AUTH_EXPORT_JOIN_PREP_READY__AUTH_EXPORT_REQUIRED`
- Owner/session: Codex automation current session, 2026-05-14 12:43-14:17 EDT / next Google Ads + Merchant operator
...
- Product-group, bid, budget, status, product, feed, or title edits are ruled out until item-level export proves which products/titles received impressions and whether a mismatch exists.
...
- Run an authenticated read-only Standard Shopping product-item export for campaign `23802638621` with item ID, product title, product group/custom label, impressions, clicks, cost, query/search-term where available, conversion value, and landing URL or product handle.
- Run `python3.13 dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-auth-export-join-prep/run_us_shopping_auth_export_join_prep.py --export-csv /path/to/authenticated-export.csv`; keep held rows out of title/feed repair decisions until their public source/title-fit issues are resolved. Use `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-held-pdp-repair-packet/US_SHOPPING_HELD_PDP_REPAIR_PACKET.md`, `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-seasonal-related-filter/US_SHOPPING_SEASONAL_RELATED_FILTER_LOCAL_FIX.md`, and `dresslikemommy-growth-2026/02_AUDIT_PACKETS/2026-05-14-automation-us-shopping-seasonal-live-sync-approval/US_SHOPPING_SEASONAL_RELATED_FILTER_LIVE_SYNC_APPROVAL_PACKET.md` for exact repair/exclusion gates and approval wording.
- If a mismatch is proven, prepare the smallest exact owner approval packet for Shopify/Merchant title/feed repair; do not mutate product/feed data from the local diagnosis alone.
...
- Pinterest authenticated access restoration.
...
Status: `ACTIVE_DIAGNOSE_READONLY__AUTOMATION_CAPABILITY_MISMATCH`
...
Current next action:
- Use an authenticated Merchant Center session to intersect the current capacity warning product list against the active `780`-row `custom_label_4=us_test_ready` / `custom_label_0=paid_eligible` cohort and Standard Shopping campaign `23802638621`.
- Keep the blocker open until that exact readback proves the active paid cohort is clear or affected.
...
Status: `ACCESS_RESTORED_DRAFT_CHECK_DONE__PAUSED_SPEC_READY`
...
- Use the restored authenticated Pinterest Ads Manager tab and `PINTEREST_US_PAUSED_DRAFT_BUILD_SPEC.md` for the next step. Since there are no saved drafts, the next UI step is `Create new campaign`; proceed only while every object can remain paused/draft and stop before any out-of-gate budget, bid, launch/publish, audience, source, feed, tag, CAPI, or catalog mutation.
