# Green Lace Garden Mommy and Me Dresses - Puff Sleeve Sundress

## Links
- **Admin:** https://admin.shopify.com/store/dresslikemommy/products/7536696328289
- **Live:** https://www.dresslikemommy.com/products/green-lace-garden-mommy-and-me-dresses
- **Vendor:** https://detail.1688.com/offer/1031966994369.html?
- **Product GID:** `gid://shopify/Product/7536696328289`
...
| DESIGNS_TO_LIST | Green only (requested Pink + Green; shipped as separate per-design listings) |
| EXCLUDE_ITEMS | none |
| SHORTCODE | auto -> `GLGD` |
| COLOR_TOKEN | auto -> `GREEN` |
...
| | Value | Chars |
|---|---|---|
| Product Title | `Green Lace Garden Mommy and Me Dresses - Puff Sleeve Sundress` | 61 |
| SEO Title | `Green Lace Garden Sundress | Dress Like Mommy` | 45 |
| SEO Description | `Lightweight green floral mommy-and-me sundresses for mom + daughter. Sizes 4Y-12Y and Mom S-XL with puff sleeves and a lace collar.` | 131 |

## SIZE_CHART recap
| Role | Vendor | Picker | SKU | Price | Cmp | shopify.size GID |
|---|---|---|---|---|---|---|
| Girl Dress | 110 | Child 4 Years | `DLM-GLGD-GRL-KID4Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/129972928609` (4-5 years) |
| Girl Dress | 120 | Child 5 Years | `DLM-GLGD-GRL-KID5Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/129972961377` (5-6 years) |
| Girl Dress | 130 | Child 6-7 Years | `DLM-GLGD-GRL-KID67Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/139840323681` (6-7 years) |
| Girl Dress | 140 | Child 8 Years | `DLM-GLGD-GRL-KID8Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/129973026913` (8) |
| Girl Dress | 150 | Child 9-10 Years | `DLM-GLGD-GRL-KID910Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/129971552353` (10) |
| Girl Dress | 160 | Child 12 Years | `DLM-GLGD-GRL-KID12Y-GREEN` | 31.99 | 36.99 | `gid://shopify/Metaobject/129971650657` (12) |
| Mother Dress | S | Mother S | `DLM-GLGD-MOM-S-GREEN` | 34.99 | 40.99 | `gid://shopify/Metaobject/129975255137` (S) |
| Mother Dress | M | Mother M | `DLM-GLGD-MOM-M-GREEN` | 34.99 | 40.99 | `gid://shopify/Metaobject/129975222369` (M) |
| Mother Dress | L | Mother L | `DLM-GLGD-MOM-L-GREEN` | 34.99 | 40.99 | `gid://shopify/Metaobject/129975189601` (L) |
| Mother Dress | XL | Mother XL | `DLM-GLGD-MOM-XL-GREEN` | 34.99 | 40.99 | `gid://shopify/Metaobject/129975287905` (XL) |
...
|---|---|---|
| Title <= 70 chars | Y | 61 |
| SEO title <= 60 chars | Y | 45 |
| SEO description <= 155 chars | Y | 131 |
| Live variant count matches SIZE_CHART | Y | 10 vs 10 |
| Live SKUs match derived SKUs | Y | DLM-GLGD-GRL-KID12Y-GREEN, DLM-GLGD-GRL-KID4Y-GREEN, DLM-GLGD-GRL-KID5Y-GREEN, DLM-GLGD-GRL-KID67Y-GREEN, DLM-GLGD-GRL-KID8Y-GREEN, DLM-GLGD-GRL-KID910Y-GREEN, DLM-GLGD-MOM-L-GREEN, DLM-GLGD-MOM-M-GREEN, DLM-GLGD-MOM-S-GREEN, DLM-GLGD-MOM-XL-GREEN |
| Live option axes match derived axes | Y | Size / Color |
| Every Size x Color combination exists | Y | [('Child 12 Years', 'Green'), ('Child 4 Years', 'Green'), ('Child 5 Years', 'Green'), ('Child 6-7 Years', 'Green'), ('Child 8 Years', 'Green'), ('Child 9-10 Years', 'Green'), ('Mother L', 'Green'), ('Mother M', 'Green'), ('Mother S', 'Green'), ('Mother XL', 'Green')] |
...
| onlineStoreUrl is populated | Y | https://www.dresslikemommy.com/products/green-lace-garden-mommy-and-me-dresses |
...
|---|---|---|---|---|---|
| DLM-GLGD-GRL-KID4Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-GRL-KID5Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-GRL-KID67Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-GRL-KID8Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-GRL-KID910Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-GRL-KID12Y-GREEN | 31.99 | 36.99 | 31.99 | 36.99 | Y |
| DLM-GLGD-MOM-S-GREEN | 34.99 | 40.99 | 34.99 | 40.99 | Y |
| DLM-GLGD-MOM-M-GREEN | 34.99 | 40.99 | 34.99 | 40.99 | Y |
| DLM-GLGD-MOM-L-GREEN | 34.99 | 40.99 | 34.99 | 40.99 | Y |
| DLM-GLGD-MOM-XL-GREEN | 34.99 | 40.99 | 34.99 | 40.99 | Y |

## Metafields - written
| Namespace.Key | Type | Value |
|---|---|---|
| custom.category1 | single_line_text_field | `Mommy and Me` |
| custom.pattern | single_line_text_field | `Green Floral` |
...
| global.description_tag | single_line_text_field | `Lightweight green floral mommy-and-me sundresses for mom + daughter. Sizes 4Y-12Y and M...` |
| global.title_tag | single_line_text_field | `Green Lace Garden Sundress | Dress Like Mommy` |
...
| mm-google-shopping.custom_label_1 | single_line_text_field | `Green Lace Garden` |
...
| shopify.color-pattern | list.metaobject_reference | `["gid://shopify/Metaobject/70220546145","gid://shopify/Metaobject/129971519585"]` |
...
## Tags written (31)
`Beach, Child 11-12yr, Child 4-5yr, Child 6-8yr, Child 9-10yr, Dresses, Floral, Garden, Girl Dress, Green, https://detail.1688.com/offer/1031966994369.html?, Lace Collar, Matching Family Dress, Matching Family Dresses, Midi Dress, Midi Dresses, Mom Size L, Mom Size M, Mom Size S, Mom Size XL, Mommy and Me, Mother Dress, Picnic, Puff Sleeve Dress, Resort, Scalloped Collar, Summer, Sundress, Sundresses, Vacation, White`
...
## Files saved
- `/Users/fsuels/Projects/dresslikemommy/ops/scripts/create-glgd-green-lace-garden-mommy-and-me-dresses.sh`
- `/Users/fsuels/Projects/dresslikemommy/ops/listings/green-lace-garden-mommy-and-me-dresses-listing.md`
- `/Users/fsuels/Projects/dresslikemommy/ops/listings/green-lace-garden-mommy-and-me-dresses-shopify-import.csv`
- `/Users/fsuels/Projects/dresslikemommy/ops/listings/verify-green-lace-garden-mommy-and-me-dresses.json`
- `/Users/fsuels/Projects/dresslikemommy/ops/listings/size-chart-green-lace-garden-mommy-and-me-dresses.json`
- `/Users/fsuels/Projects/dresslikemommy/ops/listings/body-green-lace-garden-mommy-and-me-dresses.html`
- `/Users/fsuels/Projects/dresslikemommy/uploads/green-lace-garden-mommy-and-me-dresses`

## Sources
- Price neighbor: `pastel-bloom-mommy-and-me-dresses`
