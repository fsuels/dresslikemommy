...
SETTINGS_JSON=$(cat <<'JSON'
{
  ...
  "title": "Blue Apricot Letter Family Matching Tops - Raglan Tee",
  "seo_title": "Blue Apricot Family Tops | Dress Like Mommy",
  ...
  "print_name": "Blue Apricot Letter",
  "shortcode": "BAPL",
  "color_token": "BLUE",
  ...
  "merch_type": "Top",
  "season": "Summer",
  "vendor_url": "https://detail.1688.com/offer/899442174086.html?",
  ...
  "script_path": "/Users/fsuels/Projects/dresslikemommy/ops/scripts/create-bapl-blue-apricot-letter-family-matching-tops.sh",
  "upload_dir": "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-letter-family-matching-tops",
  "listing_md": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-apricot-letter-family-matching-tops-listing.md",
  "csv_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-apricot-letter-family-matching-tops-shopify-import.csv",
  "verify_json_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/verify-blue-apricot-letter-family-matching-tops.json",
  "size_chart_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/size-chart-blue-apricot-letter-family-matching-tops.json",
  "body_html_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/body-blue-apricot-letter-family-matching-tops.html",
  ...
  "size_chart_source": "/Users/fsuels/Desktop/Screenshot 2026-04-24 at 8.39.10 AM.png",
  "required_tags": [
    "Family Matching",
    "Tops",
    ...
    "Child 8 Years",
    "Child 9-10 Years",
    "https://detail.1688.com/offer/899442174086.html?"
  ]
}
JSON
)
...
mkdir -p "${ROOT}/ops/listings" "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-letter-family-matching-tops"
...
body_html = "\n".join(
    [
        ...
        "<li><strong>Print reference:</strong> Blue Apricot Letter pairs an apricot body with navy sleeves, a red crew neckline, and sweet letter-and-heart graphics.</li>",
        "<li><strong>Design details:</strong> Short raglan sleeves, contrast neck trim, relaxed tee shape, adult letter graphics, and a child heart graphic. The denim shorts and pants shown in the photos are styling only and not included.</li>",
        ...
        *table_rows,
        ...
        "</table>",
        "",
        "<p>Blue Apricot Letter keeps matching family style easy and bright with one relaxed tee silhouette across kids and adults. The navy raglan sleeves, apricot body, and red neckline make the set feel coordinated without being too formal, while the letter-and-heart artwork gives each family member a playful photo-ready detail.</p>",
        "",
...
alt_by_name = {
    "look-1.png": "Parents and child wearing the blue apricot family matching raglan tops outdoors.",
    "look-2.png": "Family matching blue apricot raglan tops with letter and heart graphics.",
}
