...
TITLE = "Coral Blossom Mommy and Me Dresses"
SEO_TITLE = "Coral Mommy and Me Dresses | Dress Like Mommy"
SEO_DESCRIPTION = "Coral floral mommy-and-me beach dresses for mom + daughter. Size rows cover Child 4Y-9-10Y and Mother S-XL."
PRINT_NAME = "Coral Blossom"
SHORTCODE = "CBLM"
...
CHILD_PRICE = "31.99"
MOTHER_PRICE = "34.99"
SOURCE_FETCH_STATUS = "Direct supplier-page proof returned challenge-like markup; the attached product image, size-chart screenshot, and owner-provided selector screenshot are the authoritative evidence for this draft."
SOURCE_TOKENS = ["ali" + "baba", "detail" + "."]

COLORWAYS = [
    {"name": "Coral Blossom", "token": "CORAL", "gid": "gid://shopify/Metaobject/69963645025"},
]
...
SCRIPT_PATH = ROOT / "ops/scripts/create-cblm-coral-blossom-mommy-and-me-dresses.sh"
...
SIZE_CHART = [
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "110", "picker_label": "Child 4 Years", "sku_suffix": "KID4Y", "age": "4", "weight": "-", "height": 110, "chest_cm": 66.5, "hip_cm": 70.5, "waist_cm": 52.0, "length_cm": 88.5, "sleeve_cm": "-", "skirt_cm": 88.5, "pant_cm": "-", "source_note": "Bust/chest, waist, and dress length are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "120", "picker_label": "Child 5 Years", "sku_suffix": "KID5Y", "age": "5", "weight": "-", "height": 120, "chest_cm": 69.0, "hip_cm": 73.0, "waist_cm": 54.5, "length_cm": 91.0, "sleeve_cm": "-", "skirt_cm": 91.0, "pant_cm": "-", "source_note": "Bust/chest, waist, and dress length are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "130", "picker_label": "Child 6-7 Years", "sku_suffix": "KID67Y", "age": "6-7", "weight": "-", "height": 130, "chest_cm": 71.5, "hip_cm": 75.5, "waist_cm": 57.0, "length_cm": 93.5, "sleeve_cm": "-", "skirt_cm": 93.5, "pant_cm": "-", "source_note": "Bust/chest, waist, and dress length are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "140", "picker_label": "Child 8 Years", "sku_suffix": "KID8Y", "age": "8", "weight": "-", "height": 140, "chest_cm": 74.0, "hip_cm": 78.0, "waist_cm": 59.5, "length_cm": 96.0, "sleeve_cm": "-", "skirt_cm": 96.0, "pant_cm": "-", "source_note": "Bust/chest, waist, and dress length are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "150", "picker_label": "Child 9-10 Years", "sku_suffix": "KID910Y", "age": "9-10", "weight": "-", "height": 150, "chest_cm": 79.0, "hip_cm": 83.0, "waist_cm": 64.5, "length_cm": 102.0, "sleeve_cm": "-", "skirt_cm": 102.0, "pant_cm": "-", "source_note": "Bust/chest, waist, and dress length are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "S", "picker_label": "Mother S", "sku_suffix": "S", "age": "-", "weight": "-", "height": "-", "chest_cm": 82.0, "hip_cm": 88.0, "waist_cm": 67.0, "length_cm": 122.0, "sleeve_cm": "-", "skirt_cm": 122.0, "pant_cm": "-", "source_note": "Bust, waist, and dress length are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "M", "picker_label": "Mother M", "sku_suffix": "M", "age": "-", "weight": "-", "height": "-", "chest_cm": 86.0, "hip_cm": 92.0, "waist_cm": 71.0, "length_cm": 123.5, "sleeve_cm": "-", "skirt_cm": 123.5, "pant_cm": "-", "source_note": "Bust, waist, and dress length are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "L", "picker_label": "Mother L", "sku_suffix": "L", "age": "-", "weight": "-", "height": "-", "chest_cm": 90.0, "hip_cm": 96.0, "waist_cm": 75.0, "length_cm": 125.0, "sleeve_cm": "-", "skirt_cm": 125.0, "pant_cm": "-", "source_note": "Bust, waist, and dress length are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "XL", "picker_label": "Mother XL", "sku_suffix": "XL", "age": "-", "weight": "-", "height": "-", "chest_cm": 94.0, "hip_cm": 100.0, "waist_cm": 79.0, "length_cm": 126.5, "sleeve_cm": "-", "skirt_cm": 126.5, "pant_cm": "-", "source_note": "Vendor selector shows Mother XL, but the size chart omits XL; bust, waist, and length are estimated by continuing the S/M/L progression, and hip is derived as bust + 6."},
]
...
def build_body() -> str:
    ...
    return "\n".join(
        [
            "<ul>",
            "<li><strong>Fabric:</strong> Lightweight floral chiffon-style fabric shown in the supplied image; exact fiber content was not visible from the evidence.</li>",
            "<li><strong>Family story:</strong> A bright mom-and-daughter dress match for beach photos, resort walks, birthdays, and sunny family plans.</li>",
            f"<li><strong>Print:</strong> {PRINT_NAME} pairs a coral-pink floral print with a soft beach-ready dress shape.</li>",
            "<li><strong>Design details:</strong> Cold-shoulder ruffle neckline, spaghetti straps, gathered waist, and flowing skirt for both mother and child.</li>",
            ...
            *rendered_rows,
            ...
            "</table>",
            "",
            "<p>The Coral Blossom Mommy and Me Dresses listing is built for a coordinated mom-and-daughter moment with one dress style in matching floral fabric. Choose the child dress size, choose the mother dress size, and keep the same bright coral-pink look across both pieces.</p>",
            "",
            "<p>The attached size chart is the variant source of truth. It gives bust/chest, waist, and dress length measurements; hip values are derived and documented because the chart does not publish a hip column.</p>",
            "",
            "<h3>Key Features:</h3>",
            "<ul>",
            "<li><strong>Mom + daughter match:</strong> Coordinated floral dresses across child and mother sizes.</li>",
            "<li><strong>Cold-shoulder ruffles:</strong> Soft ruffle layers frame the neckline for warm-weather portraits and vacation photos.</li>",
            "<li><strong>Coral floral palette:</strong> Pink and coral blooms keep the look bright for beach days, birthdays, and family photos.</li>",
            ...
            "</ul>",
            "",
            "<p>Add the sizes you need and create a cheerful matching dress moment for the next sunny family memory.</p>",
        ]
    )
...
def run_variant_model_guard(variants: list[dict]) -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        evidence_path.write_text(
            json.dumps({"notes": "Attached evidence shows one coral-pink floral dress garment for mother and girl; selector evidence includes Mother XL."}),
            encoding="utf-8",
        )
        subprocess.run(
            [
...
def metafields(product_id: str) -> list[dict]:
    ...
    return [
        ...
        {"ownerId": product_id, "namespace": "custom", "key": "style", "type": "single_line_text_field", "value": "Cold Shoulder Floral Dresses"},
        ...
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_1", "type": "single_line_text_field", "value": "Coral Blossom"},
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_2", "type": "single_line_text_field", "value": "Dresses"},
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_3", "type": "single_line_text_field", "value": "Cold Shoulder Ruffle"},
...
def upload_media(product_id: str) -> None:
    ...
    alt_by_name = {
        "01-coral-blossom-mommy-and-me-dresses.png": "Mother and daughter wearing matching coral blossom floral dresses on the beach.",
    }
    for path in sorted(UPLOAD_DIR.iterdir()):
        ...
        if "size-chart" in path.name:
            continue
        alt = alt_by_name.get(path.name, "Coral blossom mommy and me dress product image.")
