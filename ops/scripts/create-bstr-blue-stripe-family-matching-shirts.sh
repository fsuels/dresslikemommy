...
{
  "root": "/Users/fsuels/Projects/dresslikemommy",
  "handle": "blue-stripe-family-matching-shirts",
  "title": "Blue Stripe Family Matching Tops - Button-Up Shirt",
  "seo_title": "Blue Stripe Family Shirts | Dress Like Mommy",
  "seo_description": "Blue striped family matching shirts for mom, dad, girls and boys. Long-sleeve button-up tops in Child 1-2Y-9-10Y and Adult S-3XL.",
  "print_name": "Blue Stripe",
  "shortcode": "BSTR",
  "color_token": "STRIPE",
  ...
  "script_path": "/Users/fsuels/Projects/dresslikemommy/ops/scripts/create-bstr-blue-stripe-family-matching-shirts.sh",
  "upload_dir": "/Users/fsuels/Projects/dresslikemommy/uploads/blue-stripe-family-matching-shirts",
  "listing_md": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-stripe-family-matching-shirts-listing.md",
  "csv_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-stripe-family-matching-shirts-shopify-import.csv",
  "verify_json_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/verify-blue-stripe-family-matching-shirts.json",
  "size_chart_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/size-chart-blue-stripe-family-matching-shirts.json",
  "body_html_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/body-blue-stripe-family-matching-shirts.html",
  ...
  "product_image_sources": [
    "/Users/fsuels/Projects/dresslikemommy/uploads/blue-stripe-family-matching-shirts/look-1.png",
    "/Users/fsuels/Projects/dresslikemommy/uploads/blue-stripe-family-matching-shirts/look-2.png"
  ],
  "size_chart_source": "/Users/fsuels/Projects/dresslikemommy/uploads/blue-stripe-family-matching-shirts/source-size-chart.png",
  "required_tags": [
    "Family Matching",
    "Tops",
    "Matching Family Top",
...
mkdir -p "${ROOT}/ops/listings" "/Users/fsuels/Projects/dresslikemommy/uploads/blue-stripe-family-matching-shirts"
...
body_html = "\n".join(
    [
        "<ul>",
        "<li><strong>Fabric:</strong> Soft woven-look shirt fabric with blue vertical stripes, based on the vendor imagery and the attached size-chart source.</li>",
        ...
        "<li><strong>Print reference:</strong> Blue Stripe keeps the outfit simple and versatile, with a classic collared shirt shape, vertical stripes, and visible pocket detail.</li>",
        ...
        *table_rows,
        ...
        "</table>",
        "",
        "<p>Blue Stripe is a laid-back family matching top with enough structure to look polished in photos and enough ease for real family days. The shirt works as a light overshirt over a tee, with a button front, relaxed body, and soft blue-stripe color that coordinates across kids and adults without feeling overly formal.</p>",
        "",
        ...
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>One coordinated shirt:</strong> Same blue-stripe button-up look for children and adults.</li>",
        "<li><strong>Photo-ready stripe:</strong> Soft blue color, vertical striping, chest pockets, and a casual overshirt shape.</li>",
        ...
        "</ul>",
        "",
        "<p>Choose the child and adult sizes you need to build an easy matching blue striped look for family photos, travel days, and everyday outings.</p>",
    ]
)
...
metafields = [
    ...
    {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_3", "type": "single_line_text_field", "value": "Button-Up Shirt"},
...
alt_by_name = {
    "look-1.png": "Family wearing blue stripe matching long-sleeve button-up shirts.",
    "look-2.png": "Mom, dad, and child in blue stripe family matching shirts.",
}
...
for index, row in enumerate(recap, start=1):
    ...
    values = {
        ...
        "Google Shopping / Custom Label 3": "Button-Up Shirt",
...
metafield_lines = [
    ...
    "- mm-google-shopping.custom_label_3 = `Button-Up Shirt`",
...
skipped_metafields = [
    ("shopify.clothing-features", "No honest standard clothing-features entry is needed for this blue striped family shirt."),
    ("shopify.fabric", "Skipped because the source supports a soft woven-look shirt, but it does not confirm exact fiber composition."),
...
listing_md = "\n".join(
    [
        ...
        "- The supplied images show one blue striped long-sleeve button-up shirt/overshirt for child and adult roles. Pants, white tees, hats, shoes, and cafe styling props are excluded.",
