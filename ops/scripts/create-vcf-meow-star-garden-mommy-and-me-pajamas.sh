...
TITLE="Meow Star Garden Mommy and Me Pajamas — Short-Sleeve Set"
SEO_TITLE="Cat Meadow Mommy & Me Pajamas — Set | Dress Like Mommy"
SEO_DESCRIPTION="Shop our Meow Star Garden matching mommy-and-me pajamas — soft cotton short-sleeve set for mom + daughter. Sizes 2Y–10Y & Mom S–XL."
PRINT_NAME="Meow Star Garden"
...
VENDOR_TITLE_CN="喵星花园 四层纱布亲子家居服 - 阿里巴巴"
VENDOR_TITLE_EN="Meow Star Garden four-layer gauze family loungewear — mother and child matching cotton pajama set."
DESIGNS_TO_LIST="喵星花园（成人款）, 喵星花园（儿童款）"
HERO_IMAGE_SOURCE=""
SIZE_IMAGE_SOURCE=""
...
# SIZE_CHART built from the user-supplied 尺码参数 screenshot (1688 fetch was captcha-blocked).
# 1/2胸围, 1/2臀围, 1/2腰围 columns doubled to full circumference. 衣长/肩宽/袖长/裤长 verbatim.
# Vendor offers XS and XXL in addition to S-XL; we emit only the canonical Mother S/M/L/XL picker rows.
cat > "${WORK}/size_chart.json" <<'JSON'
[
  {"audience":"child","vendor_label":"90","picker_label":"Child 2 Years","sku_suffix":"KID2Y","age":"2","weight":"12–14 kg / 26–31 lbs","height":"85–95 cm / 33–37 in","chest_cm":68,"hip_cm":69,"waist_cm":43,"length_cm":41,"sleeve_cm":33,"pant_cm":53,"shoulder_cm":27},
  {"audience":"child","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"14–17 kg / 31–37 lbs","height":"95–105 cm / 37–41 in","chest_cm":72,"hip_cm":73,"waist_cm":45,"length_cm":44,"sleeve_cm":34,"pant_cm":58,"shoulder_cm":28.5},
  {"audience":"child","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"17–20 kg / 37–44 lbs","height":"105–115 cm / 41–45 in","chest_cm":76,"hip_cm":77,"waist_cm":47,"length_cm":47,"sleeve_cm":36,"pant_cm":63,"shoulder_cm":30},
  {"audience":"child","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"20–24 kg / 44–53 lbs","height":"115–125 cm / 45–49 in","chest_cm":80,"hip_cm":81,"waist_cm":49,"length_cm":50,"sleeve_cm":42,"pant_cm":68,"shoulder_cm":31.5},
  {"audience":"child","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6–7","weight":"24–29 kg / 53–64 lbs","height":"125–135 cm / 49–53 in","chest_cm":84,"hip_cm":85,"waist_cm":52,"length_cm":53,"sleeve_cm":45,"pant_cm":73,"shoulder_cm":33},
  {"audience":"child","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"29–34 kg / 64–75 lbs","height":"135–145 cm / 53–57 in","chest_cm":88,"hip_cm":89,"waist_cm":55,"length_cm":56,"sleeve_cm":48,"pant_cm":78,"shoulder_cm":34.5},
  {"audience":"child","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9–10","weight":"34–40 kg / 75–88 lbs","height":"145–155 cm / 57–61 in","chest_cm":92,"hip_cm":93,"waist_cm":57,"length_cm":59,"sleeve_cm":51,"pant_cm":83,"shoulder_cm":36},
  {"audience":"mother","vendor_label":"S","picker_label":"Mother S","sku_suffix":"MOMS","age":"—","weight":"48–55 kg / 106–121 lbs","height":"155–162 cm / 61–64 in","chest_cm":106,"hip_cm":111,"waist_cm":73,"length_cm":66,"sleeve_cm":54,"pant_cm":97,"shoulder_cm":40.5},
  {"audience":"mother","vendor_label":"M","picker_label":"Mother M","sku_suffix":"MOMM","age":"—","weight":"55–62 kg / 121–137 lbs","height":"160–167 cm / 63–66 in","chest_cm":110,"hip_cm":115,"waist_cm":75,"length_cm":69,"sleeve_cm":54,"pant_cm":99,"shoulder_cm":42},
  {"audience":"mother","vendor_label":"L","picker_label":"Mother L","sku_suffix":"MOML","age":"—","weight":"62–70 kg / 137–154 lbs","height":"165–172 cm / 65–68 in","chest_cm":114,"hip_cm":119,"waist_cm":77,"length_cm":71,"sleeve_cm":54,"pant_cm":102,"shoulder_cm":43.5},
  {"audience":"mother","vendor_label":"XL","picker_label":"Mother XL","sku_suffix":"MOMXL","age":"—","weight":"70–78 kg / 154–172 lbs","height":"170–177 cm / 67–70 in","chest_cm":116,"hip_cm":123,"waist_cm":80,"length_cm":73,"sleeve_cm":54,"pant_cm":103,"shoulder_cm":45}
]
JSON
...
print(f"""<ul>
  <li><strong>Soft four-layer cotton gauze:</strong> The vendor calls this a 四层纱布 (four-layer gauze) loungewear set — cotton-soft, airy, and breathable for warmer nights.</li>
  ...
  <li><strong>Meow Star Garden print:</strong> Watercolor kittens, puppies, foxes, and wild meadow flowers drift across a creamy ivory ground for a storybook cottage-garden look.</li>
  <li><strong>Relaxed short-sleeve set:</strong> Notched collar, button-front top, and easy long pants keep the silhouette comfy for bedtime, breakfast, and slow family mornings.</li>
  <li><strong>Gentle-care routine:</strong> Wash cold on a delicate cycle and line dry or tumble low to help protect the soft gauze texture and the delicate watercolor print.</li>
  <li><strong>Size range:</strong> {size_range_copy} so every matching-photo moment can stay in step.</li>
</ul>
<p>&nbsp;</p>
{size_table_html}
<p>Meow Star Garden is the kind of pajama set that turns a regular night at home into a storybook moment. A creamy ivory ground is scattered with watercolor kittens, playful puppies, little foxes, and soft meadow florals, giving both the mom and daughter versions a warm, whimsical look. The four-layer cotton gauze feels light and breathable against the skin, while the notched-collar, button-front top and relaxed long pants keep the silhouette grown-up enough for mom and sweet enough for her mini-me.</p>
<p>This is a matching set made for sleepovers, birthday mornings, Mother's Day brunch at home, and the family snapshots that end up framed long after the season ends. The print reads romantic and playful all at once — perfect for tucking in with a favorite book, stretching out for Saturday pancakes, or lining up for a photo in front of the holiday tree. Add both sizes to your cart and make every bedtime, brunch, and holiday-card morning feel beautifully matched.</p>
<h3>Key Features:</h3>
<ul>
  <li><strong>Four-layer cotton gauze:</strong> Lightweight layered gauze with a soft, airy hand for warmer-weather lounging.</li>
  <li><strong>Notched-collar button-front top:</strong> A classic pajama silhouette that looks tidy on mom and sweet on her mini.</li>
  <li><strong>Relaxed long-pant cut:</strong> Easy movement for bedtime, breakfast, and slow family mornings.</li>
  <li><strong>Storybook cat &amp; meadow print:</strong> Cream, green, orange, and purple watercolor tones keep the look romantic and photo-ready.</li>
  <li><strong>True-to-vendor size run:</strong> Real vendor availability spans child 90–150 and mother S–XL.</li>
</ul>
...
NEIGHBOR_HANDLE=""
NEIGHBOR_RESPONSE=""
for candidate in fluttering-butterflies-mommy-and-me-pajamas little-sheep-meadow-mommy-and-me-pajamas grape-vineyard-mommy-and-me-pajamas; do
...
SKIPPED_METAFIELDS_JSON='[
  {"key":"shopify.clothing-features","reason":"No honest standard-catalog clothing-features entry fits a lightweight summer four-layer cotton gauze pajama set."},
...
METAFIELDS_SET_VARS="$(jq -nc \
  ...
  --arg seo_description "$SEO_DESCRIPTION" '
  {
    metafields: [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Meow Star Garden Print"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Cat Meadow"},
...
done < <(find "$UPLOAD_DIR" -maxdepth 1 -type f \( -iname '*.jpg' -o -iname '*.jpeg' -o -iname '*.png' -o -iname '*.webp' \) -print0 2>/dev/null | sort -z)
...
if [[ "${#MEDIA_FILES[@]}" -gt 0 ]]; then
  for image_path in "${MEDIA_FILES[@]}"; do
    ...
    if [[ "$image_name_lower" == *size* || "$image_name_lower" == *chart* ]]; then
      alt_text="Vendor size chart for Meow Star Garden mommy and me pajamas showing child 90-150 and mother S-XL measurements."
    else
      alt_text="Mother and daughter in matching cream Meow Star Garden four-layer cotton gauze short-sleeve pajamas with watercolor kittens and meadow florals, relaxed long pants, in a bright neutral living room."
    fi
...
# Locate any existing 75-column Shopify products_export CSV to borrow the header row.
root_dir = Path(context["root_dir"])
candidates = sorted(root_dir.glob("*-shopify-import.csv"))
header_path = None
for candidate in candidates:
    if candidate.name == Path(context["csv_out"]).name:
        continue
    header_path = candidate
    break
if header_path is None:
    raise SystemExit("No neighbor *-shopify-import.csv found to borrow header row from.")
...
for index, row in enumerate(size_chart):
    ...
    if index == 0:
        ...
        record["Google Shopping / Custom Label 1"] = "Cat Meadow"
        ...
        record["Pattern (product.metafields.custom.pattern)"] = "Meow Star Garden Print"
...
metafields_written_lines = [
    ...
    f"- shopify.size -> {len(size_chart)} catalog metaobject references in chart order",
...
if not photo_lines:
    photo_lines.append("- No vendor photo URLs were accessible (1688 captcha-blocked the direct fetch); vendor size chart screenshot supplied by user is the authoritative source.")
...
- Direct HTTP fetch of `{context['vendor_url']}` hit 1688 anti-bot/captcha markup — vendor page content was not exposed.
...
## Manual follow-ups
- **Images:** No vendor photos were attached to this run. Drop hero + lifestyle + size-chart images into `{context['upload_dir']}` and re-run this runner — the media block is idempotent and will upload any new files with scene-descriptive alt text.
