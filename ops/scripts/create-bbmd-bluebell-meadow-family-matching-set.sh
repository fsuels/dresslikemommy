...
TITLE="Bluebell Meadow Family Matching Set — Dress & Shirt"
SEO_TITLE="Bluebell Meadow Family Set | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight woven family matching set with blue floral dresses and shirts for moms, dads, girls & boys. Sizes 1-2Y–10Y, Mother S–2XL, Father S–4XL."
PRINT_NAME="Bluebell Meadow"
SHORTCODE="BBMD"
COLOR_TOKEN="BLUE"
COLOR_NAME="Bluebell Meadow"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-bbmd-bluebell-meadow-family-matching-set.sh"
...
body_html = "\n".join([
    ...
    li("Print", f"\"{print_name}\" layers periwinkle blossoms, buttery yellow sprigs, and fresh green leaves over a pale sky-blue ground for a soft, photo-ready palette."),
    li("Design details", "Girls and moms wear the coordinating square-neck dress with a smocked bodice and puff short sleeves, while boys and dads get the matching collared button-front shirt with short sleeves. The denim shorts shown with the dad shirt are styling only and not included."),
    ...
    *shirt_rows,
    ...
    "</table>",
    "",
    "<p>Bluebell Meadow gives family matching a soft garden-party feel. Moms and girls get the coordinating floral dress with a smocked bodice, puff sleeves, and easy sweeping skirt, while dads and boys wear the matching collared short-sleeve shirt in the same blue-and-yellow floral story. The whole look feels polished, airy, and naturally photo-ready.</p>",
    "",
    "<p>The dresses keep the girls' and moms' side soft and floaty for warm-weather plans, while the shirts give the boys' and dads' side a neat, relaxed finish with a clean collar and button front. Pack it for family portraits, resort dinners, vacations, or any sunny-day plan where you want every role to feel coordinated and comfortable.</p>",
    "",
    "<h3>Key Features:</h3>",
    "<ul>",
    li("Four-role coordination", "One listing covers girl dress, mother dress, boy shirt, and father shirt sizes."),
    li("Blue floral palette", "Sky-blue, periwinkle, yellow, and leafy accents keep the family look bright, soft, and easy to style."),
    li("Smocked dress shape", "The square-neck dress gives girls and moms a comfortable bodice fit with an airy, easy-moving skirt."),
    li("Shirt polish", "Collared short-sleeve shirts add a neat finish for boys and dads without feeling stiff."),
    li("Styling bottoms not included", "The denim shorts shown with the dad shirt are styling only and were intentionally excluded from this listing."),
    "</ul>",
    "",
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Bluebell Meadow Floral"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Bluebell Meadow"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Family in matching blue floral puff-sleeve dresses and short-sleeve shirts outdoors."
      ;;
    *)
      alt_text="Rack display of the Bluebell Meadow matching floral dress and short-sleeve shirts."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Bluebell Meadow")
    ...
    put("Pattern (product.metafields.custom.pattern)", "Bluebell Meadow Floral")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Blue, Yellow, Floral, Multicolor")
...
lines.append("| EXCLUDE_ITEMS | infant romper table and styling-only denim shorts excluded because the request only asked for Shirt + Dress |")
lines.append("| SHORTCODE | auto → `BBMD` |")
...
lines.append("- The dress and shirt measurement ladders were backfilled from the live `citrus-bloom-family-matching-set`, which carries the exact same `80-150 / Mother S-2XL / Father S-4XL` family-set spread as the attached fit chart.")
...
lines.append("- The denim shorts shown with the dad shirt in the supplied family photo are styling only and were excluded because the request explicitly limited the listing to the shirt and dress designs.")
lines.append("")
