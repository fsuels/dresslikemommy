...
TITLE="Pastel Bloom Mommy and Me Dresses - Sleeveless Sundress"
SEO_TITLE="Pastel Bloom Matching Sundress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight woven floral mommy-and-me sundresses for mom + daughter. Sizes 3Y-12Y and Mom M-L with an airy sleeveless resort fit."
PRINT_NAME="Pastel Bloom"
SHORTCODE="PBLM"
COLOR_TOKEN="PASTEL"
COLOR_NAME="Pastel Bloom"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-pblm-pastel-bloom-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"14-16 kg / 31-35 lbs","height":"95-105 cm / 37-41 in","chest_cm":69,"hip_cm":73,"waist_cm":69,"length_cm":68,"skirt_cm":68,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"16-19 kg / 35-42 lbs","height":"105-115 cm / 41-45 in","chest_cm":72,"hip_cm":76,"waist_cm":72,"length_cm":73,"skirt_cm":73,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"19-22 kg / 42-49 lbs","height":"115-125 cm / 45-49 in","chest_cm":75,"hip_cm":79,"waist_cm":75,"length_cm":78,"skirt_cm":78,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"22-27 kg / 49-60 lbs","height":"125-135 cm / 49-53 in","chest_cm":78,"hip_cm":82,"waist_cm":78,"length_cm":83,"skirt_cm":83,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"27-32 kg / 60-71 lbs","height":"135-145 cm / 53-57 in","chest_cm":81,"hip_cm":85,"waist_cm":81,"length_cm":88,"skirt_cm":88,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"32-38 kg / 71-84 lbs","height":"145-155 cm / 57-61 in","chest_cm":84,"hip_cm":88,"waist_cm":84,"length_cm":93,"skirt_cm":93,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"160","picker_label":"Child 12 Years","sku_suffix":"KID12Y","age":"11-12","weight":"38-46 kg / 84-101 lbs","height":"155-165 cm / 61-65 in","chest_cm":87,"hip_cm":91,"waist_cm":87,"length_cm":97,"skirt_cm":97,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"52-60 kg / 115-132 lbs","height":"160-165 cm / 63-65 in","chest_cm":90,"hip_cm":96,"waist_cm":88,"length_cm":102,"skirt_cm":102,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"60-68 kg / 132-150 lbs","height":"165-170 cm / 65-67 in","chest_cm":94,"hip_cm":100,"waist_cm":92,"length_cm":104,"skirt_cm":104,"pant_cm":0}
]
JSON
...
if child_labels == [
    ...
    "Child 9-10 Years",
    "Child 12 Years",
] and mother_labels == ["Mother M", "Mother L"]:
    size_phrase = "3Y-12Y and Mom M-L"
else:
...
body_html = "\n".join(
    [
        "<ul>",
        "<li><strong>Fabric:</strong> Lightweight polyester fabric with an airy drape that feels breezy and photo-ready for warm days.</li>",
        "<li><strong>Family story:</strong> A soft matching sundress moment for mom and daughter, made for beach walks, resort dinners, birthdays, and vacation photos.</li>",
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" mixes watercolor florals, pastel petals, and soft greenery over a light cream ground.</li>",
        "<li><strong>Design details:</strong> Sleeveless cut, tie-front neckline, gently gathered waist, and a floaty skirt that moves beautifully in the breeze.</li>",
        "<li><strong>Care:</strong> Machine wash cold on gentle, line dry, do not bleach, and use a cool iron inside-out if needed.</li>",
        "<li><strong>Size range:</strong> Girls Child 3 Years to Child 12 Years; Mother M to Mother L.</li>",
        "</ul>",
        "",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Pastel Bloom Mommy and Me Dresses were built for the kind of days that deserve a little extra softness. The watercolor floral print feels light and airy against the seaside backdrop, while the sleeveless cut and gathered waist keep the silhouette relaxed, easy, and twirl-friendly for both mom and mini.</p>",
        "",
        "<p>From beach photos to garden parties, this matching sundress set is all about effortless charm. The tie-front neckline adds a sweet detail up top, and the flowy skirt keeps every step breezy, making it an easy choice for warm-weather family moments that you want to remember.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Watercolor floral print:</strong> Soft pastel blooms and greenery create a dreamy summer look.</li>",
        "<li><strong>Breezy sleeveless fit:</strong> Lightweight woven construction keeps the silhouette easy and warm-weather friendly.</li>",
        "<li><strong>Tie-front detail:</strong> A sweet neckline accent adds polish without making the dress feel fussy.</li>",
        "<li><strong>Flowy gathered skirt:</strong> The full skirt moves beautifully for beach walks, vacations, and photos.</li>",
        "<li><strong>Mom and mini matching:</strong> Coordinated mother-and-daughter styling makes family dressing feel effortless.</li>",
        "</ul>",
        "",
        "<p>Add your sizes and bring home a matching sundress set that feels ready for every sunny family plan.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/129971519585","gid://shopify/Metaobject/130231140449"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Watercolor Floral"},
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Resort Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Pastel Bloom"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Sleeveless Sundress"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching pastel floral sleeveless sundresses by the water."
      ;;
    02-*)
      alt_text="Back view of the Pastel Bloom mommy-and-me floral sundresses at the beach."
      ;;
    03-*)
      alt_text="Side and back view of the matching pastel floral dresses with airy gathered skirts."
      ;;
    *)
      alt_text="Pastel Bloom mommy-and-me sleeveless floral sundress for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Pastel Bloom")
    put("Google Shopping / Custom Label 2", "Summer")
    put("Google Shopping / Custom Label 3", "Sleeveless Sundress")
    put("Google Shopping / Custom Label 4", "Two-Role Matching")
    put("Category1 (product.metafields.custom.category1)", "Mommy and Me")
    put("Pattern (product.metafields.custom.pattern)", "Watercolor Floral")
    put("Style (product.metafields.custom.style)", "Resort Sundress")
...
lines.append("| DESIGNS_TO_LIST | auto -> Pastel Bloom only |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `PBLM` |")
lines.append("| COLOR_TOKEN | auto -> `PASTEL` |")
...
lines.append("- `hip_cm` and `waist_cm` were derived from the prompt rules because the vendor chart only publishes dress length and chest.")
...
lines.append("- Option 1: `Size` -> `Child 3 Years`, `Child 4 Years`, `Child 5 Years`, `Child 6-7 Years`, `Child 8 Years`, `Child 9-10 Years`, `Child 12 Years`, `Mother M`, `Mother L`")
...
lines.append("- If merchandising prefers the bigger-kid label phrased as `Child 11-12 Years`, update the option label copy later while keeping the underlying `12` size metaobject reference.")
lines.append("")
