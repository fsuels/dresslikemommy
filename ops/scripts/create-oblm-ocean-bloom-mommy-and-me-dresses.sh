...
TITLE = "Ocean Bloom Mommy and Me Dresses - Beach Chiffon"
SEO_TITLE = "Blue Floral Mommy and Me Dresses | Dress Like Mommy"
SEO_DESCRIPTION = "Airy blue floral chiffon-style mommy-and-me dresses for mom + daughter. Size rows cover Child 4Y-9-10Y and Mother S-XL."
PRINT_NAME = "Ocean Bloom"
SHORTCODE = "OBLM"
...
CHILD_PRICE = "31.99"
MOTHER_PRICE = "34.99"
SOURCE_FETCH_STATUS = "Direct supplier-page proof was not usable through the web readback; the attached product and size-chart screenshots are the authoritative evidence for this draft."
SOURCE_TOKENS = ["ali" + "baba", "detail" + "."]

COLORWAYS = [
    {"name": "Ocean Blue Floral", "token": "BLUE", "gid": "gid://shopify/Metaobject/69639766113"},
]
...
SCRIPT_PATH = ROOT / "ops/scripts/create-oblm-ocean-bloom-mommy-and-me-dresses.sh"
...
SIZE_CHART = [
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "110", "picker_label": "Child 4 Years", "sku_suffix": "KID4Y", "age": "4", "weight": "-", "height": 110, "shoulder_cm": 28, "chest_cm": 43, "hip_cm": 47, "waist_cm": 43, "length_cm": 57.5, "sleeve_cm": 19.5, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as chest + 4 because the child dress chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "120", "picker_label": "Child 5 Years", "sku_suffix": "KID5Y", "age": "5", "weight": "-", "height": 120, "shoulder_cm": 29, "chest_cm": 46, "hip_cm": 50, "waist_cm": 46, "length_cm": 70, "sleeve_cm": 20, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as chest + 4 because the child dress chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "130", "picker_label": "Child 6-7 Years", "sku_suffix": "KID67Y", "age": "6-7", "weight": "-", "height": 130, "shoulder_cm": 30, "chest_cm": 49, "hip_cm": 53, "waist_cm": 49, "length_cm": 72.5, "sleeve_cm": 20.5, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as chest + 4 because the child dress chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "140", "picker_label": "Child 8 Years", "sku_suffix": "KID8Y", "age": "8", "weight": "-", "height": 140, "shoulder_cm": 31, "chest_cm": 51, "hip_cm": 55, "waist_cm": 51, "length_cm": 75, "sleeve_cm": 21, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as chest + 4 because the child dress chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "150", "picker_label": "Child 9-10 Years", "sku_suffix": "KID910Y", "age": "9-10", "weight": "-", "height": 150, "shoulder_cm": 32, "chest_cm": 56, "hip_cm": 60, "waist_cm": 56, "length_cm": 80, "sleeve_cm": 22, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as chest + 4 because the child dress chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "S", "picker_label": "Mother S", "sku_suffix": "S", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 34, "chest_cm": 62, "hip_cm": 68, "waist_cm": 88, "length_cm": 126, "sleeve_cm": 41, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as bust + 6 because the mother dress chart omits hip; waist is the source chart value."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "M", "picker_label": "Mother M", "sku_suffix": "M", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 35, "chest_cm": 66, "hip_cm": 72, "waist_cm": 92, "length_cm": 127, "sleeve_cm": 42, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as bust + 6 because the mother dress chart omits hip; waist is the source chart value."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "L", "picker_label": "Mother L", "sku_suffix": "L", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 36, "chest_cm": 70, "hip_cm": 76, "waist_cm": 96, "length_cm": 128, "sleeve_cm": 43, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as bust + 6 because the mother dress chart omits hip; waist is the source chart value."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "XL", "picker_label": "Mother XL", "sku_suffix": "XL", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 37, "chest_cm": 74, "hip_cm": 80, "waist_cm": 100, "length_cm": 129, "sleeve_cm": 44, "skirt_cm": "-", "pant_cm": "-", "source_note": "Hip derived as bust + 6 because the mother dress chart omits hip; waist is the source chart value."},
]
...
def build_body() -> str:
    ...
    return "\n".join(
        [
            "<ul>",
            "<li><strong>Fabric:</strong> Lightweight chiffon-style dress fabric with a sheer overlay look; exact fiber content was not visible from the supplied evidence.</li>",
            "<li><strong>Family story:</strong> A breezy mother-daughter match made for beach photos, vacation dinners, and sunny family days.</li>",
            f"<li><strong>Print:</strong> {PRINT_NAME} pairs an ocean-blue base with oversized black floral accents and soft green centers.</li>",
            "<li><strong>Design details:</strong> V-neckline, airy short sleeves, tie-waist shape, and a flowing skirt that moves easily for photos.</li>",
            "<li><strong>Care:</strong> Hand wash cold, reshape gently, dry flat, and avoid bleach to preserve the blue floral print.</li>",
            "<li><strong>Size range:</strong> Girls Child 4 Years to Child 9-10 Years; Mother S to Mother XL.</li>",
            "</ul>",
            "",
            "<h3>Size Chart - Ocean Bloom Dress</h3>",
            "<table id=\"size-chart\">",
            "<thead><tr>",
            ...
            *rendered_rows,
            ...
            "</table>",
            "",
            "<p>The Ocean Bloom Mommy and Me Dresses listing keeps the match simple: choose one daughter size, one mother size, and create an easy beach-ready outfit moment. The attached product image shows coordinated blue floral dresses with a relaxed tie-waist shape for both mom and daughter.</p>",
            "",
            "<p>The size table is built from the attached chart. Shoulder, bust, waist, dress length, and sleeve length are source values; hip values are derived only where the chart does not publish them, so shoppers still get a complete fit reference without unsupported size rows.</p>",
            "",
            "<h3>Key Features:</h3>",
            "<ul>",
            "<li><strong>Mom + daughter match:</strong> Coordinated dress styling across child and mother sizes.</li>",
            "<li><strong>Beach-photo palette:</strong> Ocean blue and bold florals stand out clearly in sunny vacation pictures.</li>",
            "<li><strong>Flowing chiffon look:</strong> Lightweight overlay styling gives the dress easy movement.</li>",
            "<li><strong>Chart-backed variants:</strong> Every published size maps to a visible source size row.</li>",
            "<li><strong>Draft-safe listing:</strong> Built for review before any separate publish step.</li>",
            "</ul>",
            "",
            "<p>Pick the matching mother and daughter sizes and dress the next sunny family photo in ocean-blue floral style.</p>",
        ]
    )
...
def run_variant_model_guard(variants: list[dict]) -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        evidence_path.write_text(
            json.dumps({"notes": "Attached evidence shows one blue floral dress garment for mother and girl."}),
            encoding="utf-8",
        )
        subprocess.run(
            [
...
def metafields(product_id: str) -> list[dict]:
    ...
    return [
        ...
        {"ownerId": product_id, "namespace": "custom", "key": "subcategory2", "type": "single_line_text_field", "value": "Beach Dresses"},
        {"ownerId": product_id, "namespace": "custom", "key": "pattern", "type": "single_line_text_field", "value": PRINT_NAME},
        {"ownerId": product_id, "namespace": "custom", "key": "style", "type": "single_line_text_field", "value": "Mommy and Me Beach Dresses"},
        ...
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_1", "type": "single_line_text_field", "value": "Blue Floral"},
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_2", "type": "single_line_text_field", "value": "Dresses"},
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_3", "type": "single_line_text_field", "value": "Beach"},
...
def upload_media(product_id: str) -> None:
    ...
    alt_by_name = {
        "01-ocean-bloom-mommy-and-me-dresses.png": "Mother and daughter wearing matching ocean blue floral dresses on the beach.",
    }
    for path in sorted(UPLOAD_DIR.iterdir()):
        ...
        if "size-chart" in path.name:
            continue
        alt = alt_by_name.get(path.name, "Ocean bloom mommy and me dress product image.")
