...
TITLE="Ivory Ruffle Mommy and Me Dresses - Tiered Sundress"
SEO_TITLE="Ivory Ruffle Matching Sundress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight woven mommy-and-me ruffle dresses for mom + daughter. Sizes 1-2Y through 10Y and Mom S-L with a breezy sleeveless fit."
PRINT_NAME="Ivory Ruffle"
SHORTCODE="IRFL"
COLOR_TOKEN="IVORY"
COLOR_NAME="Ivory"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-irfl-ivory-ruffle-mommy-and-me-dresses.sh"
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Ivory Ruffle"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    ...
    02-*)
      ...
      ;;
    *)
      alt_text="Ivory Ruffle mommy-and-me sleeveless tiered dress for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Ivory Ruffle")
...
lines.append("| DESIGNS_TO_LIST | auto -> Ivory Ruffle only |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `IRFL` |")
