...
HANDLE="polka-dot-mommy-and-me-dresses"
TITLE="Polka Dot Mommy and Me Dresses - Puff Sleeve Sundress"
SEO_TITLE="Polka Dot Mommy and Me Dress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight pink or white polka-dot mommy-and-me dresses for mom + daughter. Sizes 4Y-12Y and Mom S-XL."
PRINT_NAME="Polka Dot"
SHORTCODE="PDOT"
COLOR_TOKEN="DOT"
COLOR_NAME="Pink or White"
...
SEASON="Summer"
VENDOR_URL="https://detail.1688.com/offer/1041018954140.html"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-pdot-polka-dot-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"16-19 kg / 35-42 lbs","height":"110 cm / 43.3 in","chest_cm":70,"hip_cm":74,"waist_cm":70,"length_cm":69,"skirt_cm":69,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"19-22 kg / 42-49 lbs","height":"120 cm / 47.2 in","chest_cm":74,"hip_cm":78,"waist_cm":74,"length_cm":75,"skirt_cm":75,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"22-27 kg / 49-60 lbs","height":"130 cm / 51.2 in","chest_cm":78,"hip_cm":82,"waist_cm":78,"length_cm":81,"skirt_cm":81,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"27-32 kg / 60-71 lbs","height":"140 cm / 55.1 in","chest_cm":82,"hip_cm":86,"waist_cm":82,"length_cm":87,"skirt_cm":87,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"32-38 kg / 71-84 lbs","height":"150 cm / 59.1 in","chest_cm":86,"hip_cm":90,"waist_cm":86,"length_cm":93,"skirt_cm":93,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"160","picker_label":"Child 12 Years","sku_suffix":"KID12Y","age":"11-12","weight":"38-46 kg / 84-101 lbs","height":"160 cm / 63.0 in","chest_cm":90,"hip_cm":94,"waist_cm":90,"length_cm":99,"skirt_cm":99,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"S","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"45-52.5 kg / 99-116 lbs","height":"165 cm / 65.0 in","chest_cm":92,"hip_cm":98,"waist_cm":90,"length_cm":107,"skirt_cm":107,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"52.5-60 kg / 116-132 lbs","height":"170 cm / 66.9 in","chest_cm":96,"hip_cm":102,"waist_cm":94,"length_cm":109,"skirt_cm":109,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"60-67.5 kg / 132-149 lbs","height":"175 cm / 68.9 in","chest_cm":100,"hip_cm":106,"waist_cm":98,"length_cm":111,"skirt_cm":111,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"XL","picker_label":"Mother XL","sku_suffix":"XL","age":"-","weight":"67.5-75 kg / 149-165 lbs","height":"180 cm / 70.9 in","chest_cm":104,"hip_cm":110,"waist_cm":102,"length_cm":113,"skirt_cm":113,"pant_cm":0}
]
JSON
...
color_values = [{"name": color["name"]} for color in colors]
option_axes = [
    {"name": "Size", "values": [value["name"] for value in size_values]},
    {"name": "Color", "values": [color["name"] for color in colors]},
]
product_options = [
...
def sku_for(row, color):
    return f"DLM-{shortcode}-{role_tokens[row['role']]}-{size_tokens[row['picker_label']]}-{color['token']}"
...
for row in chart:
    ...
    for color in colors:
        sku = sku_for(row, color)
        option_values = [row["picker_label"], color["name"]]
        variants.append(
            {
                "price": price,
...
if child_labels == [
    ...
    "Child 9-10 Years",
    "Child 12 Years",
] and mother_labels == ["Mother S", "Mother M", "Mother L", "Mother XL"]:
    size_phrase = "4Y-12Y and Mom S-XL"
else:
...
body_html = "\n".join(
    [
        "<ul>",
        "<li><strong>Fabric:</strong> Lightweight woven polyester with a soft drape that feels airy, floaty, and photo-ready on warm days.</li>",
        "<li><strong>Family story:</strong> A picture-perfect matching dress moment for mom and daughter, made for garden parties, picnic photos, birthdays, and vacation afternoons.</li>",
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" comes in Pink or White, both finished with bold black polka dots for a playful summer look.</li>",
        "<li><strong>Design details:</strong> Puff short sleeves, statement ruffle trim, gently gathered waist, and a twirl-friendly midi skirt that moves beautifully with every step.</li>",
        "<li><strong>Care:</strong> Machine wash cold on gentle, line dry, do not bleach, and use a cool iron inside-out if needed.</li>",
        "<li><strong>Size range:</strong> Girls Child 4 Years to Child 12 Years; Mother S to Mother XL.</li>",
        "</ul>",
        "",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Polka Dot Mommy and Me Dresses bring a playful picnic-ready feel to matching family style. The airy dotted fabric brightens the silhouette, while the square neckline, puff sleeves, and ruffle trim give mom and mini a polished sunny-day look.</p>",
        "",
        "<p>From park strolls to vacation dinners, the puff sleeves and gathered skirt keep the dress looking dressed up while still feeling light and easy to wear. The side-tie waist and twirl-friendly shape make it an easy pick for portraits, birthdays, and every sunny plan in between.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Two color options:</strong> Choose Pink or White, each with bold black dots for a playful, classic finish.</li>",
        "<li><strong>Ruffle-trim neckline:</strong> Soft front ruffles and a square neckline add a sweet dress-up finish for mom and mini.</li>",
        "<li><strong>Puff short sleeves:</strong> Gentle volume at the shoulder keeps the silhouette sweet and summer friendly.</li>",
        "<li><strong>Easy gathered skirt:</strong> The relaxed midi shape moves beautifully for parties, vacations, and portraits.</li>",
        "<li><strong>Mom and mini matching:</strong> Coordinated mother-and-daughter styling makes family dressing feel effortless.</li>",
        "</ul>",
        "",
        "<p>Choose your sizes and bring home a matching polka-dot sundress set that feels ready for every warm-weather memory.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69963645025","gid://shopify/Metaobject/129971519585","gid://shopify/Metaobject/69943132257"]'
...
NECKLINE_GIDS_JSON='["gid://shopify/Metaobject/144378429537"]'
SKIRT_DRESS_LENGTH_GIDS_JSON='["gid://shopify/Metaobject/130282487905"]'
SLEEVE_LENGTH_GIDS_JSON='["gid://shopify/Metaobject/129971486817"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Polka Dot"},
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Polka Dot Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Polka Dot"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Puff Sleeve Sundress"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching pink polka-dot puff-sleeve dresses in a sunny field."
      ;;
    *)
      alt_text="Polka Dot mommy-and-me puff-sleeve sundress in pink or white."
      ;;
  esac
...
checks = [
    ...
    ("Live variant count matches derived size/color variants", len(variants) == derived["row_count"], f"{len(variants)} vs {derived['row_count']}"),
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Polka Dot")
    put("Google Shopping / Custom Label 2", "Summer")
    put("Google Shopping / Custom Label 3", "Puff Sleeve Sundress")
    put("Google Shopping / Custom Label 4", "Two-Role Matching")
    put("Category1 (product.metafields.custom.category1)", "Mommy and Me")
    put("Pattern (product.metafields.custom.pattern)", "Polka Dot")
    put("Style (product.metafields.custom.style)", "Polka Dot Sundress")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Pink, White, Black")
    put("Dress occasion (product.metafields.shopify.dress-occasion)", "Beach outings, family vacations")
    put("Dress style (product.metafields.shopify.dress-style)", "A-line")
    put("Fabric (product.metafields.shopify.fabric)", "Polyester")
    put("Neckline (product.metafields.shopify.neckline)", "V-neck")
    ...
    put("Sleeve length type (product.metafields.shopify.sleeve-length-type)", "Short")
...
lines.append("| SIZE_CHART_SOURCE | pasted size labels plus supplied product images |")
lines.append("| LISTING_MODE | Mommy and Me |")
lines.append("| PRIMARY_CATEGORY | auto -> Dresses |")
lines.append("| DESIGNS_TO_LIST | Pink and White as one listing with a Color option |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `PDOT` |")
lines.append("| COLOR_TOKEN | per variant -> `PINK` / `WHITE` |")
lines.append("| FORCE_SPEC_PRICES | true |")
lines.append("")
lines.append("## Vendor fetch status")
lines.append("The direct 1688 page was captcha-blocked during this run, so the pasted size labels and supplied product images were used as the authoritative source of truth for variants and design scope. The supplied imagery shows pink and white mother-daughter polka-dot sundresses with puff sleeves, ruffle trim, square neckline, and a softly gathered midi-length skirt. Pricing was anchored to the live dress neighbors `ivory-ruffle-mommy-and-me-dresses` and `pastel-bloom-mommy-and-me-dresses`, size references were anchored to the store's live `shopify--size` metaobject inventory, and dress-category metafields were resolved from the supplied imagery plus the store's live dress metaobject catalog.")
lines.append("")
...
lines.append("| Role | Vendor | Picker | Color | SKU | Price | Cmp | shopify.size GID |")
lines.append("|---|---|---|---|---|---|---|---|")
for recap in derived["recap"]:
    lines.append(
        f"| {recap['role']} | {recap['vendor_label']} | {recap['picker_label']} | {recap['color']} | `{recap['sku']}` | {recap['price']} | {recap['compare_at_price']} | `{recap['shopify_size_gid']}` ({recap['catalog_label']}) |"
    )
lines.append("")
lines.append("### Derivations (flagged per spec)")
lines.append("- The supplied size source provides height/size labels only, so `chest_cm`, `hip_cm`, `waist_cm`, `length_cm`, `skirt_cm`, and weight guidance were derived from the store's live dress size ladder plus the prompt's mother/child dress derivation rules.")
lines.append("- Child age cells are canonical estimates from the mapped Shopify size labels because the source provided height labels, not age ranges.")
lines.append("- The vendor `160` child row extends beyond the stock prompt table that stops at `150`, so it was mapped to `Child 12 Years` using the live Shopify `12` size metaobject instead of dropping a vendor-backed row.")
lines.append("")
...
lines.append("- Option 1: `Size` -> `Child 4 Years`, `Child 5 Years`, `Child 6-7 Years`, `Child 8 Years`, `Child 9-10 Years`, `Child 12 Years`, `Mother S`, `Mother M`, `Mother L`, `Mother XL`")
lines.append("- Option 2: `Color` -> `Pink`, `White`")
...
lines.append("- Confirm the exact fiber composition if the vendor page becomes accessible without captcha; `shopify.fabric` is set to `Polyester` as the best store-catalog match for the airy woven dress shown in the supplied imagery.")
lines.append("- Inventory quantities and per-variant grams still need operator stock values.")
lines.append("- Because the vendor chart is a fit guide rather than a garment-measurement table, recheck the derived bust/length ladder if a full spec sheet becomes available later.")
lines.append("")
