...
TITLE = "Pink Resort Ruffle Mommy and Me Dresses"
SEO_TITLE = "Pink Mommy and Me Dresses | Dress Like Mommy"
SEO_DESCRIPTION = "Breezy pink mommy-and-me dresses for mom + daughter with off-shoulder ruffles. Size rows cover Child 4Y-10Y and Mother S-XL."
PRINT_NAME = "Pink Resort Ruffle"
SHORTCODE = "PRRF"
...
SCRIPT_PATH = ROOT / "ops/scripts/create-prrf-pink-resort-ruffle-mommy-and-me-dresses.sh"
...
SIZE_CHART = [
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "110", "picker_label": "Child 4 Years", "sku_suffix": "KID4Y", "age": "4", "weight": "-", "height": 110, "chest_cm": 75.0, "hip_cm": 79.0, "waist_cm": 49.0, "length_cm": 68, "sleeve_cm": "-", "skirt_cm": 68, "pant_cm": "-"},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "120", "picker_label": "Child 5 Years", "sku_suffix": "KID5Y", "age": "5", "weight": "-", "height": 120, "chest_cm": 77.5, "hip_cm": 81.5, "waist_cm": 51.5, "length_cm": 73, "sleeve_cm": "-", "skirt_cm": 73, "pant_cm": "-"},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "133", "picker_label": "Child 6-7 Years", "sku_suffix": "KID67Y", "age": "6-7", "weight": "-", "height": 133, "chest_cm": 80.0, "hip_cm": 84.0, "waist_cm": 54.0, "length_cm": 78, "sleeve_cm": "-", "skirt_cm": 78, "pant_cm": "-"},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "140", "picker_label": "Child 8 Years", "sku_suffix": "KID8Y", "age": "8", "weight": "-", "height": 140, "chest_cm": 82.5, "hip_cm": 86.5, "waist_cm": 56.5, "length_cm": 83, "sleeve_cm": "-", "skirt_cm": 83, "pant_cm": "-"},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "150", "picker_label": "Child 9-10 Years", "sku_suffix": "KID910Y", "age": "9-10", "weight": "-", "height": 150, "chest_cm": 87.5, "hip_cm": 91.5, "waist_cm": 61.5, "length_cm": 89, "sleeve_cm": "-", "skirt_cm": 89, "pant_cm": "-"},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "S", "picker_label": "Mother S", "sku_suffix": "S", "age": "-", "weight": "-", "height": "-", "chest_cm": 103, "hip_cm": 109, "waist_cm": 64, "length_cm": 110, "sleeve_cm": "-", "skirt_cm": 110, "pant_cm": "-"},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "M", "picker_label": "Mother M", "sku_suffix": "M", "age": "-", "weight": "-", "height": "-", "chest_cm": 107, "hip_cm": 113, "waist_cm": 68, "length_cm": 111, "sleeve_cm": "-", "skirt_cm": 111, "pant_cm": "-"},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "L", "picker_label": "Mother L", "sku_suffix": "L", "age": "-", "weight": "-", "height": "-", "chest_cm": 111, "hip_cm": 117, "waist_cm": 72, "length_cm": 112, "sleeve_cm": "-", "skirt_cm": 112, "pant_cm": "-"},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "XL", "picker_label": "Mother XL", "sku_suffix": "XL", "age": "-", "weight": "-", "height": "-", "chest_cm": 115, "hip_cm": 121, "waist_cm": 76, "length_cm": 113, "sleeve_cm": "-", "skirt_cm": 113, "pant_cm": "-"},
]
...
def build_body() -> str:
    ...
    return "\n".join(
        [
            "<ul>",
            "<li><strong>Fabric:</strong> Lightweight pink woven-look fabric shown in the supplied image; exact fiber content was not visible from the evidence.</li>",
            ...
            f"<li><strong>Print:</strong> {PRINT_NAME} keeps the look soft and vacation-ready in a solid pink color story.</li>",
            "<li><strong>Design details:</strong> Off-shoulder ruffle neckline, gathered waist, relaxed skirt, and tiered hem detail for both mother and child.</li>",
            ...
            *rendered_rows,
            ...
            "</table>",
            "",
            "<p>The Pink Resort Ruffle Mommy and Me Dresses listing is built for a coordinated mom-and-daughter moment without turning the outfit into a set. Choose the child dress size, choose the mother dress size, and keep the same soft pink ruffle look across both pieces.</p>",
            "",
            "<p>The attached size chart is the variant source of truth. It gives chest, waist, and front-center skirt length measurements; hip values are derived and documented because the chart does not publish a hip column.</p>",
            "",
            "<h3>Key Features:</h3>",
            "<ul>",
            "<li><strong>Mom + daughter match:</strong> Coordinated ruffle dresses across child and mother sizes.</li>",
            "<li><strong>Photo-ready neckline:</strong> Off-shoulder ruffle styling frames warm-weather portraits and vacation photos.</li>",
            "<li><strong>Easy pink palette:</strong> Solid pink keeps the look simple for beach, resort, birthday, and family-photo outfits.</li>",
            ...
            "</ul>",
            "",
            "<p>Add the sizes you need and create a soft matching dress moment for the next sunny family memory.</p>",
        ]
    )
...
def run_variant_model_guard(variants: list[dict]) -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        evidence_path.write_text(
            json.dumps({"notes": "Attached evidence shows one dress garment in pink for mother and girl."}),
            encoding="utf-8",
        )
        subprocess.run(
            [
...
def metafields(product_id: str) -> list[dict]:
    ...
    return [
        ...
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_1", "type": "single_line_text_field", "value": "Pink"},
...
def upload_media(product_id: str) -> None:
    ...
    alt_by_name = {
        "01-pink-resort-ruffle-mommy-and-me-dresses.png": "Mother and daughter wearing matching pink resort ruffle dresses on the beach.",
    }
    for path in sorted(UPLOAD_DIR.iterdir()):
        ...
        if "size-chart" in path.name:
            continue
        alt = alt_by_name.get(path.name, "Pink resort ruffle mommy and me dress product image.")
...
def write_listing(product_id: str, product: dict, variants: list[dict], price_rows: list[dict]) -> None:
    ...
    lines = [
        ...
        *[f"- `{key}`: {reason}" for key, reason in skipped],
        ...
        "",
        "## Manual Follow-ups",
        "1. Review the draft image and pink color naming in Shopify Admin before any separate publish-live request.",
