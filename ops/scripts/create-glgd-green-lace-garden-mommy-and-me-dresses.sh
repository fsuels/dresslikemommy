...
HANDLE="green-lace-garden-mommy-and-me-dresses"
TITLE="Green Lace Garden Mommy and Me Dresses - Puff Sleeve Sundress"
SEO_TITLE="Green Lace Garden Sundress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight green floral mommy-and-me sundresses for mom + daughter. Sizes 4Y-12Y and Mom S-XL with puff sleeves and a lace collar."
PRINT_NAME="Green Lace Garden"
SHORTCODE="GLGD"
COLOR_TOKEN="GREEN"
COLOR_NAME="Green"
...
CHILD_PRICE="31.99"
MOTHER_PRICE="34.99"
PRICE_NEIGHBOR_HANDLE="pastel-bloom-mommy-and-me-dresses"
SIZE_NEIGHBOR_HANDLE="shopify--size metaobjects"

SCRIPT_PATH="${ROOT}/ops/scripts/create-glgd-green-lace-garden-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"3-4","weight":"13.5-16.5 kg / 30-36 lbs","height":"95-104 cm / 37.4-40.9 in","chest_cm":70,"hip_cm":74,"waist_cm":70,"length_cm":69,"skirt_cm":69,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"4-6","weight":"16.5-20.5 kg / 36-45 lbs","height":"104-114 cm / 40.9-44.9 in","chest_cm":74,"hip_cm":78,"waist_cm":74,"length_cm":75,"skirt_cm":75,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"7-8","weight":"20.5-25.5 kg / 45-56 lbs","height":"114-124 cm / 44.9-48.8 in","chest_cm":78,"hip_cm":82,"waist_cm":78,"length_cm":81,"skirt_cm":81,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"9-10","weight":"25.5-30.5 kg / 56-67 lbs","height":"124-134 cm / 48.8-52.8 in","chest_cm":82,"hip_cm":86,"waist_cm":82,"length_cm":87,"skirt_cm":87,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"10-11","weight":"30.5-35.5 kg / 67-78 lbs","height":"134-144 cm / 52.8-56.7 in","chest_cm":86,"hip_cm":90,"waist_cm":86,"length_cm":93,"skirt_cm":93,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"160","picker_label":"Child 12 Years","sku_suffix":"KID12Y","age":"11-12","weight":"35.5-40.5 kg / 78-89 lbs","height":"144-154 cm / 56.7-60.6 in","chest_cm":90,"hip_cm":94,"waist_cm":90,"length_cm":99,"skirt_cm":99,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"S","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"42.5-45 kg / 94-99 lbs","height":"150-155 cm / 59.1-61.0 in","chest_cm":92,"hip_cm":98,"waist_cm":90,"length_cm":107,"skirt_cm":107,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"45-52.5 kg / 99-116 lbs","height":"155-160 cm / 61.0-63.0 in","chest_cm":96,"hip_cm":102,"waist_cm":94,"length_cm":109,"skirt_cm":109,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"52.5-57.5 kg / 116-127 lbs","height":"160-165 cm / 63.0-65.0 in","chest_cm":100,"hip_cm":106,"waist_cm":98,"length_cm":111,"skirt_cm":111,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"XL","picker_label":"Mother XL","sku_suffix":"XL","age":"-","weight":"57.5-65 kg / 127-143 lbs","height":"160-170 cm / 63.0-66.9 in","chest_cm":104,"hip_cm":110,"waist_cm":102,"length_cm":113,"skirt_cm":113,"pant_cm":0}
]
JSON
...
body_html = "\n".join(
    [
        ...
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" pairs a fresh green floral print with an oversized white lace collar for a bright garden-party finish.</li>",
        "<li><strong>Design details:</strong> Puff short sleeves, statement lace collar, gently gathered waist, and a twirl-friendly midi skirt that moves beautifully with every step.</li>",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Green Lace Garden Mommy and Me Dresses bring a fresh, picnic-ready feel to matching family style. The soft green floral print keeps the silhouette airy and light, while the oversized lace collar frames the neckline with a polished, storybook finish that feels sweet without being fussy.</p>",
        "",
        "<p>From park strolls to vacation dinners, the puff sleeves and gathered skirt keep the dress looking dressed up while still feeling light and easy to wear. It is the kind of coordinated mother-daughter look that works beautifully for portraits, birthdays, and every sunny plan in between.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Green floral print:</strong> A soft garden-inspired print keeps the look fresh, bright, and photo-ready.</li>",
        "<li><strong>Oversized lace collar:</strong> The statement white collar adds a charming dress-up finish for mom and mini.</li>",
        ...
        "</ul>",
        "",
        "<p>Choose your sizes and bring home a matching floral sundress set that feels ready for every warm-weather memory.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/70220546145","gid://shopify/Metaobject/129971519585"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Green Floral"},
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Lace Collar Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Green Lace Garden"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching green floral puff-sleeve dresses with oversized white lace collars."
      ;;
    *)
      alt_text="Green Lace Garden mommy-and-me puff-sleeve floral sundress for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Green Lace Garden")
    ...
    put("Pattern (product.metafields.custom.pattern)", "Green Floral")
    put("Style (product.metafields.custom.style)", "Lace Collar Sundress")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Green, Floral")
...
lines.append("| DESIGNS_TO_LIST | Green only (requested Pink + Green; shipped as separate per-design listings) |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `GLGD` |")
lines.append("| COLOR_TOKEN | auto -> `GREEN` |")
lines.append("| FORCE_SPEC_PRICES | true |")
lines.append("")
lines.append("## Vendor fetch status")
lines.append("The direct 1688 page was captcha-blocked during this run, so the attached size-chart image was used as the authoritative source of truth for variants. The supplied lifestyle image shows a green mother-daughter floral sundress with puff sleeves, an oversized white lace collar, and a softly gathered midi-length skirt. Pricing was anchored to the live dress neighbors `pastel-bloom-mommy-and-me-dresses` and `ivory-ruffle-mommy-and-me-dresses`, size references were anchored to the store's live `shopify--size` metaobject inventory, and dress-category metafields were resolved from the supplied imagery plus the store's live dress metaobject catalog.")
lines.append("")
...
lines.append("- The attached vendor chart is a fit guide with age, height, and weight only, so `chest_cm`, `hip_cm`, `waist_cm`, `length_cm`, and `skirt_cm` were derived from the store's live dress size ladder plus the prompt's mother/child dress derivation rules.")
lines.append("- The child age cells are the vendor's printed age guidance, while the picker labels follow the canonical Shopify size mapping for 110-160.")
