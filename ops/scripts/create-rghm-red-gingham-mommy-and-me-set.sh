...
TITLE="Red Gingham Mommy and Me Set - Lace Top & Pants"
SEO_TITLE="Red Gingham Mommy & Me Set | Dress Like Mommy"
SEO_DESCRIPTION="Cotton-blend mommy-and-me set with a white lace-trim top and red gingham pants for mom + daughter. Sizes 2Y-8Y and Mom M."
PRINT_NAME="Red Gingham"
SHORTCODE="RGHM"
COLOR_TOKEN="RED"
COLOR_NAME="Red Gingham"
...
MERCH_SUBCATEGORY="Sets"
MERCH_SUBCATEGORY2="Summer Matching Sets"
MERCH_STYLE="Lace Top & Gingham Pants"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-rghm-red-gingham-mommy-and-me-set.sh"
...
[
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"90","picker_label":"Child 2 Years","sku_suffix":"KID2Y","age":"2","weight":"12-14.5 kg / 26.5-32.0 lbs","height":"85-90 cm / 33.5-35.4 in","chest_cm":60,"hip_cm":64,"waist_cm":42,"length_cm":37,"sleeve_cm":0,"pant_cm":52},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"15-17.5 kg / 33.1-38.6 lbs","height":"95-100 cm / 37.4-39.4 in","chest_cm":62,"hip_cm":66,"waist_cm":44,"length_cm":39,"sleeve_cm":0,"pant_cm":57},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"18-20 kg / 39.7-44.1 lbs","height":"105-110 cm / 41.3-43.3 in","chest_cm":64,"hip_cm":68,"waist_cm":46,"length_cm":41,"sleeve_cm":0,"pant_cm":62},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"20.5-22.5 kg / 45.2-49.6 lbs","height":"115-120 cm / 45.3-47.2 in","chest_cm":67,"hip_cm":71,"waist_cm":48,"length_cm":43.5,"sleeve_cm":0,"pant_cm":66.5},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"23-25 kg / 50.7-55.1 lbs","height":"125-130 cm / 49.2-51.2 in","chest_cm":70,"hip_cm":74,"waist_cm":50,"length_cm":46,"sleeve_cm":0,"pant_cm":71},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"25.5-30 kg / 56.2-66.1 lbs","height":"130-135 cm / 51.2-53.1 in","chest_cm":72,"hip_cm":76,"waist_cm":52,"length_cm":49,"sleeve_cm":0,"pant_cm":76},
  {"audience":"mother","role":"Mother Set","garment":"Set","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"67 kg or less / 135 lbs or less","height":"160-168 cm / 63.0-66.1 in","chest_cm":88,"hip_cm":92,"waist_cm":58,"length_cm":60,"sleeve_cm":0,"pant_cm":100}
]
JSON
...
def size_phrase():
    ...
    moms = "Mom M" if mother_labels == ["Mother M"] else "Mom " + ", ".join(label.replace("Mother ", "") for label in mother_labels)
...
for row in chart:
    rows_html.append(
        ...
        f"<td>{'—' if row.get('sleeve_cm', 0) in (0, 0.0) else cm_in(row['sleeve_cm'])}</td>"
...
body_html = "\n".join([
    "<ul>",
    li("Fabric", "Lightweight cotton-blend woven set with an airy sleeveless top and soft red gingham pants for summer wear."),
    li("Family story", "A cheerful matching set for mom and daughter, made for picnics, vacations, garden days, and photo-ready summer plans."),
    li("Print", f"\"{print_name}\" pairs a white lace-trim peplum top with red gingham wide-leg pants."),
    li("Design details", "Sleeveless gathered top, delicate lace trim, relaxed peplum shape, pull-on waistband, and easy wide-leg gingham pants."),
    li("Care", "Machine wash cold on gentle, line dry, do not bleach, and use a cool iron on the reverse if needed."),
    li("Size range", f"Girls Child 2 Years to Child 8 Years; Mother M."),
    "</ul>",
    "",
    ...
    *rows_html,
    ...
    "</table>",
    "",
    "<p>Bring a picnic-bright mood to your matching-moment wardrobe with the Red Gingham Mommy and Me Set. The white sleeveless top has soft gathers and lace-trim detail, while the red gingham pants add playful movement and an easy pull-on fit. It is sweet for garden photos, summer trips, and the kind of ordinary afternoons that deserve a little matching magic.</p>",
    "",
    "<p>The styling is relaxed but polished: a breezy white top, soft peplum shape, and red checked wide-leg pants that feel easy without losing the photo-ready charm. Wear it for picnics, vacations, weekend brunch, or any day you want your mom-and-mini look to feel fresh, coordinated, and comfortable.</p>",
    "",
    "<h3>Key Features:</h3>",
    "<ul>",
    li("Airy summer feel", "Lightweight cotton-blend woven fabric keeps the set comfortable on sunny days."),
    li("Photo-ready contrast", "White lace trim and red gingham create a classic picnic-ready palette."),
    li("Two-piece versatility", "Style the lace-trim top and gingham pants together or mix them with closet basics."),
    li("Pull-on comfort", "The easy waistband and relaxed wide-leg cut help each size move comfortably."),
    li("Mom + mini matching", "Both roles share the same sweet summer outfit for easy twinning."),
    "</ul>",
    "",
    "<p>Add your sizes and make the next picnic, vacation day, or family photo feel instantly coordinated.</p>",
])
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69600804961","gid://shopify/Metaobject/69639733345","gid://shopify/Metaobject/130283143265"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Red Gingham"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Red Gingham"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Lace Top & Gingham Pants"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter wearing a white lace-trim top and red gingham pants matching set outdoors."
      ;;
    02-*)
      alt_text="Red gingham mommy-and-me summer set with white sleeveless tops and wide-leg pants in garden light."
      ;;
    03-*)
      alt_text="Girls red gingham matching set with a white sleeveless lace-trim top and wide-leg pants."
      ;;
    04-*)
      alt_text="Red gingham mommy-and-me top and pants set for mother and daughter."
      ;;
    *)
      alt_text="Red gingham mommy-and-me lace-trim top and pants set for mother and daughter."
      ;;
  esac
...
for _attempt in {1..12}; do
  if echo "$VERIFY_RESPONSE" | jq -e '.data.product.collections.nodes | map(.handle) | index("mommy-and-me") != null' > /dev/null; then
    break
  fi
  sleep 3
  VERIFY_RESPONSE="$(gql "$VERIFY_QUERY" "$(jq -nc --arg id "$PRODUCT_ID" '{id:$id}')")"
...
checks = [
    ...
    ("Set merchandising tag is present", merch_collection_tag in product["tags"], ", ".join(product["tags"])),
    ("Mommy and Me smart collection is attached", "mommy-and-me" in collection_handles, str(sorted(collection_handles))),
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Red Gingham")
    put("Google Shopping / Custom Label 2", "Summer")
    put("Google Shopping / Custom Label 3", "Lace Top & Gingham Pants")
    put("Google Shopping / Custom Label 4", "Two-Role Matching")
    put("Category1 (product.metafields.custom.category1)", "Mommy and Me")
    put("Pattern (product.metafields.custom.pattern)", "Red Gingham")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Red, White, Checkered")
...
lines.append("- The vendor chart labels bust and waist as half measurements (`*2`), so `chest_cm` and `waist_cm` were doubled into full circumference values.")
lines.append("- Child `height` uses the vendor chart exactly; child `weight` was derived from the store's standard size guidance because the vendor chart omits child weight.")
lines.append("- Mother `height` guidance was derived from the store's standard mother size guidance because the vendor chart provides recommended weight only for adult M.")
lines.append("- `hip_cm` was derived as `chest_cm + 4` from the store's loose summer set grading because the vendor chart omits hip.")
lines.append("- The `Sleeve or Skirt` body column is `—` for every row because the top is sleeveless and the product is a pants set, not a skirt set.")
lines.append("")
...
lines.append("- No exclusions were requested, so every vendor-supported mommy-and-me row in the attached chart was kept.")
lines.append("")
lines.append("## Body HTML")
lines.append("- 1 `<ul>` with 6 bullets (fabric, family story, print, design details, care, size range).")
lines.append("- 1 `<h3>` + 1 size table with 10 `<th>` headers and 7 body rows.")
