...
# Phases: productCreate -> productVariantsBulkCreate -> metafieldsSet -> media attach.
...
TAGS_JSON='["Mommy and Me","Pajamas","Matching Family Pajamas","Short Sleeve Pajamas","Summer","Cream","Sage","Fruit Print","Apple Print","Orchard","Bird Chirping","Storybook","Whimsical","Child 2-3yr","Child 4-5yr","Child 6-8yr","Child 9-10yr","Mother S","Mother M","Mother L","Mother XL"]'
...
# ============= STEP 4: publish is intentionally skipped =============
echo ">>> publish skipped: listing runners are draft-only unless a separate publish step is explicitly approved" >&2
