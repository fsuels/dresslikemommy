...
TITLE = "Red Tropical Leaf Mommy and Me Dresses"
SEO_TITLE = "Red Mommy and Me Dresses | Dress Like Mommy"
SEO_DESCRIPTION = "Red leaf-print mommy-and-me beach dresses for mom + daughter. Size rows cover Child 4Y-12Y and Mother S-2XL."
PRINT_NAME = "Red Tropical Leaf"
SHORTCODE = "RTLF"
...
CHILD_PRICE = "31.99"
MOTHER_PRICE = "34.99"
SOURCE_FETCH_STATUS = "Direct supplier-page proof was not used for customer-facing data; the attached product and size-chart screenshots are the authoritative evidence for this draft."
SOURCE_TOKENS = ["ali" + "baba", "detail" + "."]
APPROVED_ACTIVE_PRODUCT_ID = "gid://shopify/Product/7607762845793"

COLORWAYS = [
    {"name": "Red Tropical Leaf", "token": "RED", "gid": "gid://shopify/Metaobject/69600804961"},
]
...
SCRIPT_PATH = ROOT / "ops/scripts/create-rtlf-red-tropical-leaf-mommy-and-me-dresses.sh"
...
SIZE_CHART = [
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "110", "picker_label": "Child 4 Years", "sku_suffix": "KID4Y", "age": "4", "weight": "-", "height": 110, "shoulder_cm": 29, "chest_cm": 70.5, "hip_cm": 74.5, "waist_cm": 50.5, "length_cm": 69.5, "sleeve_cm": "-", "skirt_cm": 69.5, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "120", "picker_label": "Child 5 Years", "sku_suffix": "KID5Y", "age": "5", "weight": "-", "height": 120, "shoulder_cm": 30, "chest_cm": 73, "hip_cm": 77, "waist_cm": 53, "length_cm": 72, "sleeve_cm": "-", "skirt_cm": 72, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "130", "picker_label": "Child 6-7 Years", "sku_suffix": "KID67Y", "age": "6-7", "weight": "-", "height": 130, "shoulder_cm": 31, "chest_cm": 75.5, "hip_cm": 79.5, "waist_cm": 55.5, "length_cm": 74.5, "sleeve_cm": "-", "skirt_cm": 74.5, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "140", "picker_label": "Child 8 Years", "sku_suffix": "KID8Y", "age": "8", "weight": "-", "height": 140, "shoulder_cm": 32, "chest_cm": 78, "hip_cm": 82, "waist_cm": 58, "length_cm": 77, "sleeve_cm": "-", "skirt_cm": 77, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "150", "picker_label": "Child 9-10 Years", "sku_suffix": "KID910Y", "age": "9-10", "weight": "-", "height": 150, "shoulder_cm": 33.5, "chest_cm": 83, "hip_cm": 87, "waist_cm": 63, "length_cm": 83, "sleeve_cm": "-", "skirt_cm": 83, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as chest + 4 because the chart omits hip."},
    {"audience": "child", "role": "Girl Dress", "garment": "Dress", "vendor_label": "160", "picker_label": "Child 12 Years", "sku_suffix": "KID12Y", "age": "11-12", "weight": "-", "height": 160, "shoulder_cm": 35, "chest_cm": 88, "hip_cm": 92, "waist_cm": 68, "length_cm": 89, "sleeve_cm": "-", "skirt_cm": 89, "pant_cm": "-", "source_note": "Estimated from the selector-backed 160cm row because the chart omits 160cm measurements; measurements extend the last visible child grading step from 150cm."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "S", "picker_label": "Mother S", "sku_suffix": "S", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 35.5, "chest_cm": 86, "hip_cm": 92, "waist_cm": 65, "length_cm": 134, "sleeve_cm": "-", "skirt_cm": 134, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "M", "picker_label": "Mother M", "sku_suffix": "M", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 36.5, "chest_cm": 90, "hip_cm": 96, "waist_cm": 69, "length_cm": 135.5, "sleeve_cm": "-", "skirt_cm": 135.5, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "L", "picker_label": "Mother L", "sku_suffix": "L", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 37.5, "chest_cm": 94, "hip_cm": 100, "waist_cm": 73, "length_cm": 137, "sleeve_cm": "-", "skirt_cm": 137, "pant_cm": "-", "source_note": "Chest, waist, length, and shoulder are chart values; hip is derived as bust + 6 because the chart omits hip."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "XL1", "picker_label": "Mother XL", "sku_suffix": "XL", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 38.5, "chest_cm": 98, "hip_cm": 104, "waist_cm": 77, "length_cm": 138.5, "sleeve_cm": "-", "skirt_cm": 138.5, "pant_cm": "-", "source_note": "Estimated from selector-backed XL1 row because the chart omits XL measurements; adult chart grading from S to L is continued by +4 bust, +4 waist, +1 shoulder, and +1.5 length."},
    {"audience": "mother", "role": "Mother Dress", "garment": "Dress", "vendor_label": "XXL1", "picker_label": "Mother 2XL", "sku_suffix": "2XL", "age": "-", "weight": "-", "height": "-", "shoulder_cm": 39.5, "chest_cm": 102, "hip_cm": 108, "waist_cm": 81, "length_cm": 140, "sleeve_cm": "-", "skirt_cm": 140, "pant_cm": "-", "source_note": "Estimated from selector-backed XXL1 row because the chart omits 2XL measurements; adult chart grading from S to L is continued by +4 bust, +4 waist, +1 shoulder, and +1.5 length."},
]
...
def build_body() -> str:
    ...
    return "\n".join(
        [
            "<ul>",
            "<li><strong>Fabric:</strong> Lightweight red chiffon-style fabric shown in the supplied image; exact fiber content was not visible from the evidence.</li>",
            "<li><strong>Family story:</strong> A breezy mom-and-daughter dress match for beach photos, resort walks, birthdays, and sunny family plans.</li>",
            f"<li><strong>Print:</strong> {PRINT_NAME} keeps the look soft and vacation-ready in a bright red tropical leaf print.</li>",
            "<li><strong>Design details:</strong> V-neck wrap-style front, tie waist, airy sleeves, and a softly tiered skirt for both mother and child.</li>",
            "<li><strong>Care:</strong> Hand wash cold, reshape gently, hang or lay flat to dry, and avoid bleach or rough surfaces.</li>",
            "<li><strong>Size range:</strong> Girls Child 4 Years to Child 12 Years; Mother S to Mother 2XL. Child 12 Years, Mother XL, and Mother 2XL use estimated measurements from the visible selector sizes.</li>",
            "</ul>",
            "",
            "<h3>Size Chart - Red Tropical Leaf Dress</h3>",
            "<table id=\"size-chart\">",
            "<thead><tr>",
            ...
            *rendered_rows,
            ...
            "</table>",
            "",
            "<p>The Red Tropical Leaf Mommy and Me Dresses listing is built for a coordinated mom-and-daughter moment without turning the outfit into a set. Choose the child dress size, choose the mother dress size, and keep the same bright red tropical leaf dress look across both pieces.</p>",
            "",
            "<p>The attached size chart is the variant source of truth for measured rows. The visible selector also shows 160cm, XL1, and XXL1 as purchasable sizes; those rows are included with estimated measurements using the chart's grading pattern and should be reviewed before publishing.</p>",
            "",
            "<h3>Key Features:</h3>",
            "<ul>",
            "<li><strong>Mom + daughter match:</strong> Coordinated red tropical dresses across child and mother sizes.</li>",
            "<li><strong>Photo-ready wrap silhouette:</strong> V-neck wrap-style styling frames warm-weather portraits and vacation photos.</li>",
            "<li><strong>Bright beach palette:</strong> Red tropical leaves keep the look bold for beach, resort, birthday, and family-photo outfits.</li>",
            ...
            "</ul>",
            "",
            "<p>Add the sizes you need and create a bright matching dress moment for the next sunny family memory.</p>",
        ]
    )
...
def run_variant_model_guard(variants: list[dict]) -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        evidence_path.write_text(
            json.dumps({"notes": "Attached evidence shows one red tropical leaf dress garment for mother and girl."}),
            encoding="utf-8",
        )
        subprocess.run(
            [
...
def create_or_update_product(body: str, variants: list[dict]) -> tuple[str, bool, str, list[str]]:
    ...
    if existing is None:
        ...
        return product_id, True, "DRAFT", []

    product_id = existing["id"]
    if existing["status"] != "DRAFT" and product_id != APPROVED_ACTIVE_PRODUCT_ID:
        raise RuntimeError(f"Existing product {HANDLE} is {existing['status']}; refusing to change an unapproved non-draft product.")
    existing_publications = sorted(
        node["publication"]["id"]
        for node in existing.get("resourcePublicationsV2", {}).get("nodes", [])
    ...
    data = gql(
        ...
        {"product": {"id": product_id, **product_input(body, status=existing["status"])}},
    )
    ...
    return product_id, False, existing["status"], existing_publications
...
def metafields(product_id: str) -> list[dict]:
    ...
    return [
        ...
        {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_1", "type": "single_line_text_field", "value": "Red Tropical Leaf"},
...
def upload_media(product_id: str) -> None:
    ...
    alt_by_name = {
        "01-red-tropical-leaf-mommy-and-me-dresses.png": "Mother and daughter wearing matching red tropical leaf dresses on the beach.",
    }
    for path in sorted(UPLOAD_DIR.iterdir()):
        ...
        if "size-chart" in path.name:
            continue
        alt = alt_by_name.get(path.name, "Red Tropical Leaf mommy and me dress product image.")
...
def verify_product(product: dict, variants: list[dict], expected_status: str, expected_publications: list[str]) -> tuple[list[str], list[dict]]:
    ...
    if live_publications != expected_publications:
        errors.append(f"publication IDs changed: {live_publications} vs {expected_publications}")
    if expected_status == "DRAFT":
        ...
        if live_publications:
            errors.append("draft product is published to at least one sales channel")
...
def write_listing(product_id: str, product: dict, variants: list[dict], price_rows: list[dict]) -> None:
    ...
    lines = [
        ...
        *recap,
        ...
        f"| Publication check | PASS | publishedAt={product.get('publishedAt')}; onlineStoreUrl={product.get('onlineStoreUrl')}; preserved live channels={live_channels} |",
...
def main() -> None:
    ...
    product_id, created, expected_status, expected_publications = create_or_update_product(body, variants)
    set_metafields(product_id)
    upload_media(product_id)
    product = verify_query(product_id)
    errors, price_rows = verify_product(product, variants, expected_status, expected_publications)
        ...
        json.dumps(
            {
                ...
                "expected_publication_ids": expected_publications,
                "live_publication_ids": sorted(
                    node["publication"]["id"]
                    for node in product["resourcePublicationsV2"]["nodes"]
                    if node.get("isPublished")
                ),
