...
{
  "root": "/Users/fsuels/Projects/dresslikemommy",
  "handle": "playful-graphic-family-matching-tops",
  "title": "Playful Graphic Family Matching Tops - Cartoon Tee",
  "seo_title": "Playful Graphic Family Tops | Dress Like Mommy",
  "seo_description": "Soft white graphic tees for mom, dad, girls and boys. Sizes children 1-2Y-9-10Y, Mother S-2XL and Father S-4XL.",
  "print_name": "Playful Graphic",
  "shortcode": "PGFX",
  "color_token": "WHITE",
  "color_name": "White Graphic",
  ...
  "merch_subcategory2": "Matching Family Graphic Tees",
  ...
  "child_price": "24.99",
  "adult_price": "28.99",
  "upload_dir": "/Users/fsuels/Projects/dresslikemommy/uploads/playful-graphic-family-matching-tops",
  "listing_md": "/Users/fsuels/Projects/dresslikemommy/ops/listings/playful-graphic-family-matching-tops-listing.md",
  "csv_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/playful-graphic-family-matching-tops-shopify-import.csv",
  "verify_json_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/verify-playful-graphic-family-matching-tops.json",
  "size_chart_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/size-chart-playful-graphic-family-matching-tops.json",
  "body_html_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/body-playful-graphic-family-matching-tops.html",
  "age_group_gids": [
  ...
  "product_image_sources": [
    "/Users/fsuels/Projects/dresslikemommy/uploads/playful-graphic-family-matching-tops/look-1.png",
    "/Users/fsuels/Projects/dresslikemommy/uploads/playful-graphic-family-matching-tops/look-2.png"
  ],
  "size_chart_source": "/Users/fsuels/Projects/dresslikemommy/uploads/playful-graphic-family-matching-tops/size-chart.png"
}
JSON
)
...
[
  {
    "picker_label": "Girl 1-2 Years",
    "gid": "gid://shopify/Metaobject/129972797537",
    "catalog_label": "12-18 months"
  },
  {
    "picker_label": "Girl 2 Years",
    "gid": "gid://shopify/Metaobject/129972863073",
    "catalog_label": "2-3 years"
  },
  {
    "picker_label": "Girl 3 Years",
    "gid": "gid://shopify/Metaobject/129972895841",
    "catalog_label": "3-4 years"
  },
  {
    "picker_label": "Girl 4 Years",
    "gid": "gid://shopify/Metaobject/129972928609",
    "catalog_label": "4-5 years"
  },
  {
    "picker_label": "Girl 5 Years",
    "gid": "gid://shopify/Metaobject/129972961377",
    "catalog_label": "5-6 years"
  },
  {
    "picker_label": "Girl 6-7 Years",
    "gid": "gid://shopify/Metaobject/139840323681",
    "catalog_label": "6-7 years"
  },
  {
    "picker_label": "Girl 8 Years",
    "gid": "gid://shopify/Metaobject/139840356449",
    "catalog_label": "7-8 years"
  },
  {
    "picker_label": "Girl 9-10 Years",
    "gid": "gid://shopify/Metaobject/139840389217",
    "catalog_label": "8-9 years closest match"
  },
  {
    "picker_label": "Boy 1-2 Years",
    "gid": "gid://shopify/Metaobject/129972797537",
  ...
  {
    "picker_label": "Mother S",
    "gid": "gid://shopify/Metaobject/129975255137",
    "catalog_label": "S"
  },
  {
    "picker_label": "Mother M",
    "gid": "gid://shopify/Metaobject/129975222369",
    "catalog_label": "M"
  },
  {
    "picker_label": "Mother L",
    "gid": "gid://shopify/Metaobject/129975189601",
    "catalog_label": "L"
  },
  {
    "picker_label": "Mother XL",
    "gid": "gid://shopify/Metaobject/129975287905",
    "catalog_label": "XL"
  },
  {
    "picker_label": "Mother 2XL",
    "gid": "gid://shopify/Metaobject/129975156833",
    "catalog_label": "2XL"
  },
  {
    "picker_label": "Father S",
  ...
  {
    "picker_label": "Father 3XL",
    "gid": "gid://shopify/Metaobject/139840421985",
    "catalog_label": "3XL"
  },
  {
    "picker_label": "Father 4XL",
    "gid": "gid://shopify/Metaobject/139840716897",
    "catalog_label": "4XL"
  }
]
JSON
...
size_tokens = {
    ...
    "Father S": "S", "Father M": "M", "Father L": "L", "Father XL": "XL", "Father 2XL": "2XL", "Father 3XL": "3XL", "Father 4XL": "4XL",
}
...
size_range_copy = "girls and boys 1-2Y through 9-10Y, mothers S-2XL, and fathers S-4XL"
...
body_html = "\n".join([
    "<ul>",
    "<li><strong>Fabric:</strong> Soft knit T-shirt fabric based on the supplied photos; the blocked vendor page did not expose exact fiber content.</li>",
    "<li><strong>Family story:</strong> A playful white graphic tee for mom, dad, girls, and boys, made for casual family days, travel photos, and matching weekend outfits.</li>",
    "<li><strong>Print reference:</strong> Playful Graphic places cheerful cartoon icons across the shoulder and chest for a bright, kid-friendly matching look.</li>",
    "<li><strong>Design details:</strong> Crew neckline, short sleeves, easy relaxed tee shape, and one white graphic colorway. Shorts, denim, sunglasses, bags, shoes, and other props shown in photos are styling only.</li>",
    "<li><strong>Care:</strong> Machine wash cold on gentle, wash inside out with similar colors, line dry or tumble low, and avoid bleach. This care guidance is conservative because direct vendor care text was not available.</li>",
    ...
    *rows_html,
    "</tbody></table>",
    "<p>Playful Graphic keeps the family match light and easy: a white tee with colorful cartoon details that feels right for park days, vacation snapshots, and relaxed summer plans.</p>",
    "<p>The attached vendor chart publishes fit guidance by height and weight for children, mothers, and fathers. Because it does not publish garment measurements, chest, sleeve, and length follow the store's existing family tee grading curve while hip and waist are derived by the canonical top rules.</p>",
    "<h3>Key Features:</h3>",
    "<ul>",
    "<li><strong>Four-role family match:</strong> Sizes are prepared for girls, boys, mothers, and fathers.</li>",
    "<li><strong>Cheerful graphic look:</strong> Colorful cartoon icons add a playful family-photo detail.</li>",
    "<li><strong>Easy tee silhouette:</strong> Crew-neck short-sleeve tops pair naturally with denim, shorts, skirts, or casual trousers.</li>",
    "<li><strong>Vendor-backed fit range:</strong> Child 80-150, Mother S-2XL, and Father S-4XL rows are transcribed from the attached chart.</li>",
    "<li><strong>Single included garment:</strong> This listing covers the graphic tees only; the infant crawler table and all styled accessories are not included.</li>",
    "</ul>",
    "<p>Choose each family member's size and build a matching white graphic tee outfit for sunny plans, casual portraits, and everyday memories.</p>",
])
tags = sorted({
    "Family Matching", "Mommy and Me", "Daddy and Me", "Tops", "Matching Family Tops", "Matching Family Shirts",
    "Graphic Tee", "Cartoon Tee", "Short Sleeve Top", "Playful Graphic", "White", "Multicolor", "Cartoon",
    "Summer", "Vacation", "Family Photos", "Matching Family Outfits",
...
alt_by_name = {
    "look-1.png": "Mom and dad wearing the white playful graphic family matching tees.",
    "look-2.png": "Mom, dad, and child wearing white cartoon graphic matching tees.",
}
...
skipped = [
    ("shopify.fabric", "Skipped because the source supports only a soft knit T-shirt appearance, not an exact fiber metaobject."),
    ("shopify.neckline", "Skipped because the crew neckline is visible, but no verified writable standard neckline GID was confirmed for this taxonomy."),
    ("shopify.sleeve-length-type", "Skipped because the photos support short sleeves, but no verified writable standard sleeve-length GID was confirmed for this taxonomy."),
...
listing_md = "\n".join([
    ...
    "| DESIGNS_TO_LIST | auto -> one White Graphic T-shirt colorway |",
    "| Variant model | Size / Color; role-bearing Size labels keep mom/dad/girl/boy variants unique |",
    "| FORCE_SPEC_PRICES | true |",
    "",
    "## Vendor source-of-truth",
    "- Direct public access to the 1688 offer returned Alibaba anti-bot challenge markup, so the attached size chart and product images were used as authoritative evidence.",
    "- The chart publishes fit-reference rows for child tops 80-150, mother tops S-2XL, father tops S-4XL, and a separate infant crawler table.",
    "- The supplied product photos show matching white short-sleeve graphic T-shirts for mom, dad, and child; infant crawler rows were excluded from this Tops listing.",
    "- The chart provides height and weight only, so chest, sleeve, and length use the store's existing family tee grading curve; hip and waist are derived per canonical top rules.",
    "- `体重` values are domestic jin ranges and were converted to kg.",
    "- Product photos show white graphic tees, denim, shorts, sunglasses, bags, shoes, and props; styling-only items are not included.",
    "",
    "## Title & SEO",
    ...
    *price_lines,
    ...
    "- If the vendor page becomes readable later, confirm exact fabric content and whether the separate infant crawler should become its own listing.",
    "",
    "## Files",
    f"- `{listing_md_path}`",
    f"- `{csv_out_path}`",
    ...
    f"- `{Path('/Users/fsuels/Projects/dresslikemommy/ops/scripts/create-pgfx-playful-graphic-family-matching-tops.sh')}`",
])
