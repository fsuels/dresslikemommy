...
TITLE="Ivory Tiered Mommy and Me Dresses - Ruffle Sundress"
SEO_TITLE="Ivory Tiered Matching Dress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight ivory tiered mommy-and-me dresses for mom + daughter. Sizes 1-2Y through 10Y and Mom S-L with a breezy sleeveless fit."
PRINT_NAME="Ivory Tiered Ruffle"
SHORTCODE="ITRF"
COLOR_TOKEN="IVORY"
COLOR_NAME="Ivory"
...
CHILD_PRICE="31.99"
MOTHER_PRICE="34.99"
PRICE_NEIGHBOR_HANDLE="white-lace-mommy-and-me-dresses"
SIZE_NEIGHBOR_HANDLE="shopify--size metaobjects"

SCRIPT_PATH="${ROOT}/ops/scripts/create-itrf-ivory-tiered-ruffle-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"80","picker_label":"Child 1-2 Years","sku_suffix":"KID12Y","age":"1-2","weight":"9-12 kg / 20-25 lbs","height":"75-85 cm / 30-33 in","chest_cm":62,"hip_cm":66,"waist_cm":62,"length_cm":54,"skirt_cm":54,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"90","picker_label":"Child 2 Years","sku_suffix":"KID2Y","age":"2","weight":"12-15 kg / 26-32 lbs","height":"86-95 cm / 34-37 in","chest_cm":64,"hip_cm":68,"waist_cm":64,"length_cm":59,"skirt_cm":59,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"15-18 kg / 33-39 lbs","height":"96-105 cm / 38-41 in","chest_cm":66,"hip_cm":70,"waist_cm":66,"length_cm":65,"skirt_cm":65,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"18-20 kg / 40-44 lbs","height":"106-115 cm / 42-45 in","chest_cm":70,"hip_cm":74,"waist_cm":70,"length_cm":71,"skirt_cm":71,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"20-23 kg / 45-50 lbs","height":"116-125 cm / 46-49 in","chest_cm":74,"hip_cm":78,"waist_cm":74,"length_cm":77,"skirt_cm":77,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"23-25 kg / 51-55 lbs","height":"126-135 cm / 50-53 in","chest_cm":78,"hip_cm":82,"waist_cm":78,"length_cm":83,"skirt_cm":83,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"26-30 kg / 56-66 lbs","height":"136-145 cm / 54-57 in","chest_cm":84,"hip_cm":88,"waist_cm":84,"length_cm":89,"skirt_cm":89,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"31-40 kg / 67-88 lbs","height":"145-155 cm / 57-61 in","chest_cm":90,"hip_cm":94,"waist_cm":90,"length_cm":95,"skirt_cm":95,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"S","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"48-58 kg / 106-128 lbs","height":"155-165 cm / 61-65 in","chest_cm":92,"hip_cm":98,"waist_cm":90,"length_cm":106,"skirt_cm":106,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"58-63 kg / 128-139 lbs","height":"160-170 cm / 63-67 in","chest_cm":94,"hip_cm":100,"waist_cm":92,"length_cm":107,"skirt_cm":107,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"63-70 kg / 139-154 lbs","height":"165-175 cm / 65-69 in","chest_cm":96,"hip_cm":102,"waist_cm":94,"length_cm":108,"skirt_cm":108,"pant_cm":0}
]
JSON
...
body_html = "\n".join(
    [
        "<ul>",
        "<li><strong>Fabric:</strong> Lightweight woven polyester fabric with an airy drape that feels breezy, floaty, and photo-ready on warm days.</li>",
        "<li><strong>Family story:</strong> A fresh matching sundress moment for mom and daughter, made for beach walks, resort dinners, birthdays, and summer photos.</li>",
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" keeps the look bright and airy with a soft ivory tone, a gathered neckline, and layered ruffle tiers.</li>",
        "<li><strong>Design details:</strong> Sleeveless round neckline, relaxed A-line shape, roomy fit, and tiered ruffle panels that move beautifully with every step.</li>",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Ivory Tiered Ruffle Mommy and Me Dresses are made for sunlit getaways, family photos, and slow summer afternoons. The lightweight woven fabric keeps the look airy, while the softly gathered neckline and cascading ruffle tiers give both mom and mini an easy, floaty silhouette that moves beautifully with every step.</p>",
        "",
        "<p>From beach walks to birthday brunches, this sleeveless matching dress set feels polished without losing its playful charm. The solid ivory color keeps styling simple, and the roomy tiered cut pairs just as easily with sandals and bows as it does with woven bags and vacation snapshots.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Airy woven feel:</strong> Lightweight polyester keeps the silhouette easy and warm-weather friendly.</li>",
        "<li><strong>Soft gathered neckline:</strong> A smooth round neckline adds polish while keeping the fit relaxed.</li>",
        "<li><strong>Layered ruffle tiers:</strong> Cascading panels create volume, movement, and a twirl-friendly finish.</li>",
        "<li><strong>Breezy sleeveless cut:</strong> An easy shape that styles well for travel, parties, and everyday sunny plans.</li>",
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Tiered Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Ivory Tiered Ruffle"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Tiered Sundress"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching ivory sleeveless tiered ruffle dresses indoors."
      ;;
    02-*)
      alt_text="Back view of the mommy-and-me ivory ruffle dresses with layered tiers."
      ;;
    *)
      alt_text="Ivory Tiered Ruffle mommy-and-me sleeveless tiered dress for mother and daughter."
      ;;
  esac
...
checks = [
    ...
    ("Product status is DRAFT", product["status"] == "DRAFT", product["status"] or ""),
    ("publishedAt is null", product["publishedAt"] is None, product["publishedAt"] or "null"),
    ("onlineStoreUrl is blank for draft", product["onlineStoreUrl"] is None, product["onlineStoreUrl"] or "not published"),
    (
...
links = {
    ...
    "live": product["onlineStoreUrl"] or "not published",
}
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Ivory Tiered Ruffle")
    put("Google Shopping / Custom Label 2", "Summer")
    put("Google Shopping / Custom Label 3", "Tiered Sundress")
    ...
    put("Style (product.metafields.custom.style)", "Tiered Sundress")
...
lines.append("- `hip_cm` and `waist_cm` were derived from the prompt rules because the vendor chart only publishes dress length and chest guidance.")
...
lines.append("- Draft only. The runner did not call `publishablePublish`, `publishedAt` is null, and no sales-channel publication is live.")
lines.append("")
...
if collections:
    ...
    lines.append("- No smart collections were returned for the draft product. Collection indexing may wait until publication.")
lines.append("")
