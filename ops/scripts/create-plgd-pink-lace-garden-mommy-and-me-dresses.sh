...
TITLE="Pink Lace Garden Mommy and Me Dresses - Puff Sleeve Sundress"
SEO_TITLE="Pink Lace Garden Sundress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight floral mommy-and-me sundresses for mom + daughter. Sizes 4Y-12Y and Mom S-XL with puff sleeves and a lace collar."
PRINT_NAME="Pink Lace Garden"
SHORTCODE="PLGD"
COLOR_TOKEN="PINK"
COLOR_NAME="Pink"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-plgd-pink-lace-garden-mommy-and-me-dresses.sh"
...
body_html = "\n".join(
    [
        ...
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" pairs a pink floral print with an oversized white lace collar for a sweet garden-party finish.</li>",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Pink Lace Garden Mommy and Me Dresses bring a romantic, picnic-ready feel to matching family style. The soft pink floral print brightens the silhouette, while the oversized lace collar frames the neckline with a polished, storybook finish that feels sweet without being fussy.</p>",
        "",
        ...
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Pink floral print:</strong> A soft garden-inspired print keeps the look bright, feminine, and photo-ready.</li>",
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69963645025","gid://shopify/Metaobject/129971519585"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Pink Floral"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Pink Lace Garden"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching pink floral puff-sleeve dresses with oversized white lace collars."
      ;;
    *)
      alt_text="Pink Lace Garden mommy-and-me puff-sleeve floral sundress for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Pink Lace Garden")
    ...
    put("Pattern (product.metafields.custom.pattern)", "Pink Floral")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Pink, Floral")
...
lines.append("| DESIGNS_TO_LIST | Pink only (requested Pink + Green; shipped as separate per-design listings) |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `PLGD` |")
