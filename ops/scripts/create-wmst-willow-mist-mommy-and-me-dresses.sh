...
TITLE="Willow Mist Mommy and Me Dresses - Floral Hem Sundress"
SEO_TITLE="Willow Mist Matching Dresses | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight woven mommy-and-me dresses for mom + daughter in white or green. Sizes 4Y-12Y and Mom S-L with floral hems."
PRINT_NAME="Willow Mist"
SHORTCODE="WMST"
COLOR_TOKEN="MIST"
COLOR_NAME="White or Green"
...
CHILD_PRICE="31.99"
MOTHER_PRICE="34.99"
PRICE_NEIGHBOR_HANDLE="green-lace-garden-mommy-and-me-dresses"
SIZE_NEIGHBOR_HANDLE="shopify--size metaobjects"

SCRIPT_PATH="${ROOT}/ops/scripts/create-wmst-willow-mist-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"-","height":"110 cm / 43.3 in","chest_cm":59,"hip_cm":63,"waist_cm":59,"length_cm":59,"skirt_cm":59,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"-","height":"120 cm / 47.2 in","chest_cm":62.5,"hip_cm":66.5,"waist_cm":62.5,"length_cm":73.5,"skirt_cm":73.5,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"-","height":"130 cm / 51.2 in","chest_cm":66,"hip_cm":70,"waist_cm":66,"length_cm":78,"skirt_cm":78,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"-","height":"140 cm / 55.1 in","chest_cm":69.5,"hip_cm":73.5,"waist_cm":69.5,"length_cm":82.5,"skirt_cm":82.5,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"-","height":"150 cm / 59.1 in","chest_cm":73,"hip_cm":77,"waist_cm":73,"length_cm":87,"skirt_cm":87,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"160","picker_label":"Child 12 Years","sku_suffix":"KID12Y","age":"11-12","weight":"-","height":"160 cm / 63.0 in","chest_cm":76.5,"hip_cm":80.5,"waist_cm":76.5,"length_cm":91.5,"skirt_cm":91.5,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"165","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"-","height":"165 cm / 65.0 in","chest_cm":80.5,"hip_cm":86.5,"waist_cm":78.5,"length_cm":103.5,"skirt_cm":103.5,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"170","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"-","height":"170 cm / 66.9 in","chest_cm":84.5,"hip_cm":90.5,"waist_cm":82.5,"length_cm":108,"skirt_cm":108,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"175","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"-","height":"175 cm / 68.9 in","chest_cm":88.5,"hip_cm":94.5,"waist_cm":86.5,"length_cm":112.5,"skirt_cm":112.5,"pant_cm":0}
]
JSON
...
if child_labels == [
    ...
    size_phrase = "4Y-12Y and Mom S-L"
else:
...
body_html = "\n".join(
    [
        ...
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" comes in White or Green, both finished with soft blue-green soft floral hems for a playful summer look.</li>",
        "<li><strong>Design details:</strong> Shoulder tie straps, square neckline, sheer overlay, smocked back, gently gathered waist, and a twirl-friendly midi skirt that moves beautifully with every step.</li>",
        "<li><strong>Care:</strong> Machine wash cold on gentle, line dry, do not bleach, and use a cool iron inside-out if needed.</li>",
        "<li><strong>Size range:</strong> Girls Child 4 Years to Child 12 Years; Mother S to Mother L.</li>",
        "</ul>",
        "",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Willow Mist Mommy and Me Dresses bring a soft picnic-ready feel to matching family style. The sheer overlay and blue-green floral hem brighten the silhouette, while the square neckline and shoulder ties give mom and mini a polished sunny-day look.</p>",
        "",
        "<p>From park strolls to vacation dinners, the tie straps and gathered skirt keep the dress looking dressed up while still feeling light and easy to wear. The side-tie waist and twirl-friendly shape make it an easy pick for portraits, birthdays, and every sunny plan in between.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Two color options:</strong> Choose White or Green, each with a delicate floral hem for a fresh, garden-inspired finish.</li>",
        "<li><strong>Tie-strap neckline:</strong> Shoulder ties and a square neckline add a sweet dress-up finish for mom and mini.</li>",
        "<li><strong>Sleeveless summer shape:</strong> Tie straps and an airy bodice keep the silhouette sweet and warm-weather friendly.</li>",
        ...
        "</ul>",
        "",
        "<p>Choose your sizes and bring home a matching floral-hem sundress set that feels ready for every warm-weather memory.</p>",
    ]
)
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Willow Mist"},
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Willow Mist Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Willow Mist"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Tie-Strap Sundress"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching white floral-hem tie-strap dresses by the water."
      ;;
    *)
      alt_text="Willow Mist mommy-and-me tie-strap floral-hem sundress in white or green."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Willow Mist")
    put("Google Shopping / Custom Label 2", "Summer")
    put("Google Shopping / Custom Label 3", "Tie-Strap Sundress")
    put("Google Shopping / Custom Label 4", "Two-Role Matching")
    put("Category1 (product.metafields.custom.category1)", "Mommy and Me")
    put("Pattern (product.metafields.custom.pattern)", "Willow Mist")
    put("Style (product.metafields.custom.style)", "Willow Mist Sundress")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "White, Green, Floral")
...
lines.append("- The attached chart publishes vendor label, skirt length, and chest/bust in cm. Hip and waist are derived per the master prompt: child hip = chest + 4, child waist = chest; mother hip = bust + 6, mother waist = hip - 8.")
lines.append("- The attached chart does not publish weight guidance, so weight cells are shown as `-` instead of inventing ranges.")
...
lines.append("- 165 -> Mother S")
lines.append("- 170 -> Mother M")
lines.append("- 175 -> Mother L")
lines.append("")
...
lines.append("- 1 `<h3>` plus 1 size table with 10 `<th>` headers and 9 body rows.")
...
lines.append("- Option 1: `Size` -> `Child 4 Years`, `Child 5 Years`, `Child 6-7 Years`, `Child 8 Years`, `Child 9-10 Years`, `Child 12 Years`, `Mother S`, `Mother M`, `Mother L`")
lines.append("- Option 2: `Color` -> `White`, `Green`")
