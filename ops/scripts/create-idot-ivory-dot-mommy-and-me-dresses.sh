...
HANDLE="ivory-dot-mommy-and-me-dresses"
TITLE="Ivory Dot Mommy and Me Dresses - Puff Sleeve Sundress"
SEO_TITLE="Ivory Dot Mommy and Me Dress | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight ivory polka-dot mommy-and-me dresses for mom + daughter. Sizes 1-2Y through 10Y and Mom S-L."
PRINT_NAME="Ivory Dot"
SHORTCODE="IDOT"
COLOR_TOKEN="IVORY"
COLOR_NAME="Ivory"
...
SEASON="Summer"
VENDOR_URL="https://detail.1688.com/offer/1042309825160.html?"
VENDOR="dresslikemommy.com"
FORCE_SPEC_PRICES="true"
CHILD_PRICE="31.99"
MOTHER_PRICE="34.99"
PRICE_NEIGHBOR_HANDLE="polka-dot-mommy-and-me-dresses"
SIZE_NEIGHBOR_HANDLE="shopify--size metaobjects"

SCRIPT_PATH="${ROOT}/ops/scripts/create-idot-ivory-dot-mommy-and-me-dresses.sh"
...
[
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"80","picker_label":"Child 1-2 Years","sku_suffix":"KID12Y","age":"1-2","weight":"9-11.5 kg / 20-25 lbs","height":"75-85 cm / 30-33 in","chest_cm":52,"hip_cm":56,"waist_cm":52,"length_cm":55,"skirt_cm":55,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"90","picker_label":"Child 2 Years","sku_suffix":"KID2Y","age":"2","weight":"12-14.5 kg / 26-32 lbs","height":"86-95 cm / 34-37 in","chest_cm":54,"hip_cm":58,"waist_cm":54,"length_cm":60,"skirt_cm":60,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"15-17.5 kg / 33-39 lbs","height":"96-105 cm / 38-41 in","chest_cm":58,"hip_cm":62,"waist_cm":58,"length_cm":65,"skirt_cm":65,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"18-20 kg / 40-44 lbs","height":"106-115 cm / 42-45 in","chest_cm":60,"hip_cm":64,"waist_cm":60,"length_cm":71,"skirt_cm":71,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"20.5-22.5 kg / 45-50 lbs","height":"116-125 cm / 46-49 in","chest_cm":64,"hip_cm":68,"waist_cm":64,"length_cm":77,"skirt_cm":77,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"23-25 kg / 51-55 lbs","height":"126-135 cm / 50-53 in","chest_cm":68,"hip_cm":72,"waist_cm":68,"length_cm":82,"skirt_cm":82,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"25.5-30 kg / 56-66 lbs","height":"136-145 cm / 54-57 in","chest_cm":72,"hip_cm":76,"waist_cm":72,"length_cm":88,"skirt_cm":88,"pant_cm":0},
  {"audience":"child","role":"Girl Dress","garment":"Dress","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"30.5-40 kg / 67-88 lbs","height":"145-155 cm / 57-61 in","chest_cm":76,"hip_cm":80,"waist_cm":76,"length_cm":94,"skirt_cm":94,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"S","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"47.5-57.5 kg / 105-127 lbs","height":"-","chest_cm":78,"hip_cm":84,"waist_cm":76,"length_cm":104,"skirt_cm":104,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"58-62.5 kg / 128-138 lbs","height":"-","chest_cm":82,"hip_cm":88,"waist_cm":80,"length_cm":105,"skirt_cm":105,"pant_cm":0},
  {"audience":"mother","role":"Mother Dress","garment":"Dress","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"63-69.5 kg / 139-153 lbs","height":"-","chest_cm":86,"hip_cm":92,"waist_cm":84,"length_cm":106,"skirt_cm":106,"pant_cm":0}
]
JSON
...
body_html = "\n".join(
    [
        ...
        "<li><strong>Family story:</strong> A fresh matching sundress moment for mom and daughter, made for studio photos, resort dinners, birthdays, and summer afternoons.</li>",
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" pairs a soft ivory base with tiny black polka dots for a clean, playful mother-daughter look.</li>",
        "<li><strong>Design details:</strong> Square neckline, ruched bodice, petite puff sleeves, gathered waist, and a softly flowing midi skirt.</li>",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Ivory Dot Mommy and Me Dresses are made for sunlit getaways, family photos, and slow summer afternoons. The lightweight woven fabric keeps the look airy, while the ruched bodice, square neckline, and tiny black dots give both mom and mini a polished, playful silhouette.</p>",
        "",
        "<p>From birthday brunches to vacation dinners, this matching puff-sleeve dress set feels sweet without losing its easy charm. The ivory-and-black palette keeps styling simple, and the gathered midi skirt pairs just as easily with ballet flats and bows as it does with woven bags and family snapshots.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Airy woven feel:</strong> Lightweight polyester keeps the silhouette easy and warm-weather friendly.</li>",
        "<li><strong>Square neckline:</strong> A clean neckline frames the dotted bodice with a polished vintage-inspired shape.</li>",
        "<li><strong>Petite puff sleeves:</strong> Soft shoulder volume keeps the silhouette sweet and photo-ready.</li>",
        "<li><strong>Ruched bodice:</strong> Gentle front ruching adds texture while keeping the fit relaxed and wearable.</li>",
        "<li><strong>Mom and mini matching:</strong> Coordinated mother-and-daughter styling makes family dressing feel effortless.</li>",
        "</ul>",
        "",
        "<p>Choose your sizes and bring home a dotted ivory matching dress set that feels ready for every warm-weather memory.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69639733345","gid://shopify/Metaobject/69943132257"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "style", type: "single_line_text_field", value: "Puff Sleeve Sundress"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Ivory Dot"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching ivory polka-dot puff-sleeve dresses indoors."
      ;;
    02-*)
      alt_text="Mother and daughter seated in matching ivory polka-dot puff-sleeve dresses."
      ;;
    *)
      alt_text="Ivory Dot mommy-and-me puff-sleeve dress for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Ivory Dot")
    ...
    put("Style (product.metafields.custom.style)", "Puff Sleeve Sundress")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Ivory, Black")
    ...
    put("Neckline (product.metafields.shopify.neckline)", "Square")
...
lines.append("| DESIGNS_TO_LIST | auto -> Ivory Dot only |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `IDOT` |")
lines.append("| COLOR_TOKEN | auto -> `IVORY` |")
lines.append("| FORCE_SPEC_PRICES | true |")
lines.append("")
lines.append("## Vendor fetch status")
lines.append("The direct 1688 page was captcha-blocked during this run, so the attached size-chart image was used as the authoritative source of truth for variants. The supplied lifestyle images show a mother-daughter ivory polka-dot sundress with petite puff sleeves, a square neckline, ruched bodice, gathered waist, and an airy midi-length silhouette. Pricing was anchored to the live dress neighbor `polka-dot-mommy-and-me-dresses`, size references were anchored to the store's live `shopify--size` metaobject inventory, and the chart's fit-report rows were transcribed below for rerun continuity.")
lines.append("")
...
lines.append("- Mother-row height cells are left as `-` because the vendor chart leaves adult recommended height blank.")
lines.append("")
