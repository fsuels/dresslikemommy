...
TITLE="Black Bow Mommy and Me Set - Tie-Neck Top & Skirt"
SEO_TITLE="Black Bow Mommy & Me Set | Dress Like Mommy"
SEO_DESCRIPTION="Lightweight black mommy-and-me two-piece set for mom + daughter with sleeveless tie-neck top and flouncy skirt. Sizes 2Y-10Y and Mom S-L."
PRINT_NAME="Black Bow"
SHORTCODE="BBTS"
COLOR_TOKEN="BLACK"
COLOR_NAME="Black"
...
MERCH_STYLE="Tie-Neck Top & Skirt"
...
SCRIPT_PATH="${ROOT}/ops/scripts/create-bbts-black-bow-mommy-and-me-set.sh"
...
[
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"90","picker_label":"Child 2 Years","sku_suffix":"KID2Y","age":"2","weight":"12-14.5 kg / 26.5-32.0 lbs","height":"86-95 cm / 33.9-37.4 in","chest_cm":64,"hip_cm":68,"waist_cm":44,"length_cm":37,"skirt_cm":32,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"100","picker_label":"Child 3 Years","sku_suffix":"KID3Y","age":"3","weight":"15-17.5 kg / 33.1-38.6 lbs","height":"96-105 cm / 37.8-41.3 in","chest_cm":66,"hip_cm":70,"waist_cm":46,"length_cm":40,"skirt_cm":34,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"110","picker_label":"Child 4 Years","sku_suffix":"KID4Y","age":"4","weight":"18-20 kg / 39.7-44.1 lbs","height":"106-115 cm / 41.7-45.3 in","chest_cm":70,"hip_cm":74,"waist_cm":48,"length_cm":43,"skirt_cm":36,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"120","picker_label":"Child 5 Years","sku_suffix":"KID5Y","age":"5","weight":"20.5-22.5 kg / 45.2-49.6 lbs","height":"116-125 cm / 45.7-49.2 in","chest_cm":74,"hip_cm":78,"waist_cm":50,"length_cm":46,"skirt_cm":38,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"130","picker_label":"Child 6-7 Years","sku_suffix":"KID67Y","age":"6-7","weight":"23-25 kg / 50.7-55.1 lbs","height":"126-135 cm / 49.6-53.1 in","chest_cm":78,"hip_cm":82,"waist_cm":52,"length_cm":49,"skirt_cm":40,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"140","picker_label":"Child 8 Years","sku_suffix":"KID8Y","age":"8","weight":"25.5-30 kg / 56.2-66.1 lbs","height":"136-145 cm / 53.5-57.1 in","chest_cm":82,"hip_cm":86,"waist_cm":54,"length_cm":52,"skirt_cm":42,"pant_cm":0},
  {"audience":"child","role":"Girl Set","garment":"Set","vendor_label":"150","picker_label":"Child 9-10 Years","sku_suffix":"KID910Y","age":"9-10","weight":"30.5-40 kg / 67.2-88.2 lbs","height":"145-155 cm / 57.1-61.0 in","chest_cm":86,"hip_cm":90,"waist_cm":56,"length_cm":55,"skirt_cm":44,"pant_cm":0},
  {"audience":"mother","role":"Mother Set","garment":"Set","vendor_label":"S","picker_label":"Mother S","sku_suffix":"S","age":"-","weight":"47.5-57.5 kg / 104.7-126.8 lbs","height":"155-165 cm / 61.0-65.0 in","chest_cm":88,"hip_cm":92,"waist_cm":58,"length_cm":61,"skirt_cm":41,"pant_cm":0},
  {"audience":"mother","role":"Mother Set","garment":"Set","vendor_label":"M","picker_label":"Mother M","sku_suffix":"M","age":"-","weight":"58-62.5 kg / 127.9-137.8 lbs","height":"160-170 cm / 63.0-66.9 in","chest_cm":92,"hip_cm":96,"waist_cm":60,"length_cm":62,"skirt_cm":42,"pant_cm":0},
  {"audience":"mother","role":"Mother Set","garment":"Set","vendor_label":"L","picker_label":"Mother L","sku_suffix":"L","age":"-","weight":"63-69.5 kg / 138.9-153.2 lbs","height":"165-175 cm / 65.0-68.9 in","chest_cm":96,"hip_cm":100,"waist_cm":62,"length_cm":63,"skirt_cm":43,"pant_cm":0}
]
JSON
...
size_phrase = "2Y-10Y and Mom S-L"
...
body_html = "\n".join(
    [
        ...
        li("Family story", "A polished black mom-and-daughter look made for vacations, birthday photos, city strolls, and easy summer afternoons."),
        li("Print", f"\"{print_name}\" is a solid black set with a bow-style tie neckline, soft drape, and a flouncy mini skirt."),
        li("Design details", "Sleeveless tie-neck top, softly gathered neckline, relaxed peplum-style hem, elastic-waist skirt, and easy movement through every step and twirl."),
        li("Care", "Machine wash cold on gentle, line dry, do not bleach, and use a cool iron on the reverse if needed."),
        li("Size range", "Girls Child 2 Years to Child 9-10 Years; Mother S to Mother L."),
        "</ul>",
        "",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Black Bow Mommy and Me Set brings a polished boutique feel to matching-moment dressing. The sleeveless tie-neck top skims softly away from the body, while the flouncy skirt adds movement that feels polished enough for family photos and relaxed enough for all-day summer plans.</p>",
        "",
        "<p>From cafe strolls to birthday lunches and travel snapshots, this two-piece look keeps styling simple without losing that dressed-up charm. The solid black tone feels classic and elevated, and the top-and-skirt pairing makes the outfit feel airy, twirl-friendly, and easy to accessorize with sandals, bows, and woven bags.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        li("Airy two-piece silhouette", "The sleeveless top and flouncy skirt feel light, comfortable, and warm-weather ready."),
        li("Tie-neck detail", "Long front ties create the bow-inspired neckline shown in the supplied photos."),
        li("Flouncy skirt", "A short layered skirt adds movement and a photo-ready finish for vacations and special outings."),
        li("Easy elastic waist", "The skirt waistband helps keep the fit comfortable for both mom and mini."),
        li("Mom and mini coordination", "Both roles share the same elegant black outfit story for effortless twinning."),
        "</ul>",
        "",
        "<p>Choose your sizes and bring home a black mommy-and-me set that feels ready for every warm-weather memory.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69943132257"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Black"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Black Bow"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_2", type: "single_line_text_field", value: "Summer"},
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_3", type: "single_line_text_field", value: "Tie-Neck Top & Skirt"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Flat lay of the black sleeveless mommy-and-me top and flouncy skirt set."
      ;;
    02-*)
      alt_text="Girl wearing the black sleeveless tie-neck top and flouncy skirt from the mommy-and-me matching set."
      ;;
    03-*)
      alt_text="Mother wearing the black sleeveless top and flouncy skirt from the mommy-and-me matching set."
      ;;
    *)
      alt_text="Black mommy-and-me sleeveless top and skirt set for mother and daughter."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Black")
...
lines.append("| SIZE_CHART_SOURCE | pasted vendor fit labels plus supplied product images |")
lines.append("| LISTING_MODE | Mommy and Me |")
lines.append("| PRIMARY_CATEGORY | auto -> Sets (Shopify taxonomy kept as Outfit Sets) |")
lines.append("| DESIGNS_TO_LIST | auto -> black mother-daughter top + skirt set only |")
lines.append("| EXCLUDE_ITEMS | none |")
lines.append("| SHORTCODE | auto -> `BBTS` |")
lines.append("| COLOR_TOKEN | auto -> `BLACK` |")
lines.append("| FORCE_SPEC_PRICES | true |")
lines.append("")
lines.append("## Vendor fetch status")
lines.append("The direct 1688 page returned Alibaba anti-bot/captcha markup during this run, so the pasted vendor fit labels and supplied lifestyle photos were used as the authoritative source of truth. The supplied images show a black sleeveless tie-neck top with a flouncy skirt for girls and mothers. Pricing was anchored to `powder-blue-mommy-and-me-set`, and size metaobject GIDs were anchored to `ivory-ruffle-mommy-and-me-dresses`.")
lines.append("")
...
lines.append("- The supplied source gives size/fit labels only, not a full garment-measurement table, so `chest_cm`, `waist_cm`, `hip_cm`, `length_cm`, and `skirt_cm` were derived from the store's live loose summer set grading anchored to `powder-blue-mommy-and-me-set`.")
lines.append("- `hip_cm` was derived as `chest_cm + 4` from the store's loose summer set grading because the vendor size notes omit hip.")
lines.append("- `length_cm` represents the sleeveless top length; `skirt_cm` represents the separate flouncy skirt length so the set keeps both garment measurements distinct.")
lines.append("- Mother-row height guidance was derived from the store's live mommy-and-me dress/set ladder because the supplied vendor notes only publish S/M/L labels.")
lines.append("")
...
lines.append("- Kept every supplied mommy-and-me row: child 90-150 plus mother S/M/L.")
lines.append("")
lines.append("## Body HTML")
lines.append("- 1 `<ul>` with 6 bullets (fabric, family story, print, design details, care, size range).")
lines.append(f"- 1 `<h3>` + 1 size table with 10 `<th>` headers and {len(chart)} body rows.")
