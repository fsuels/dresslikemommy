...
TITLE="Gray Leopard Mommy and Me Swimsuits - Ruffle Bikini"
SEO_TITLE="Gray Leopard Mommy & Me Swimsuits | Dress Like Mommy"
SEO_DESCRIPTION="Stretch gray leopard mommy-and-me swimsuits for mom + daughter. Girls 2Y-12Y and Mother S-XL with ruffle bikini styling."
PRINT_NAME="Gray Leopard"
SHORTCODE="GLPD"
COLOR_TOKEN="GRAY"
COLOR_NAME="Gray Leopard"
...
CHILD_PRICE="14.99"
MOTHER_PRICE="16.99"
PRICE_NEIGHBOR_HANDLE="blush-garden-mommy-and-me-swimsuits"
SIZE_NEIGHBOR_HANDLE="live-shopify-size-metaobject"

SCRIPT_PATH="${ROOT}/ops/scripts/create-glpd-gray-leopard-mommy-and-me-swimsuits.sh"
...
body_html = "\n".join(
    [
        ...
        f"<li><strong>Print:</strong> \"{html.escape(print_name)}\" pairs a gray leopard ruffle top with classic black swim bottoms for a bold, photo-ready match.</li>",
        "<li><strong>Design details:</strong> Ruffled spaghetti-strap bikini tops, high-waist bottoms, and a sheer tie-side swim skirt shown on the mother style.</li>",
        ...
        *rows_html,
        ...
        "</table>",
        "",
        "<p>The Gray Leopard Mommy and Me Swimsuits bring a playful beach look to matching family style. The gray leopard ruffle top adds movement and personality, while the black bottoms keep the set easy to style for pool days, resort mornings, and sunny family photos.</p>",
        "",
        "<p>The girls' and moms' suits coordinate through the same leopard print and ruffled neckline, with adult body measurements supplied for bust, waist, and hip. Choose the chart-backed size for each swimmer and add coverups, sandals, or hats separately as styling pieces.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Leopard ruffle top:</strong> A gray animal print and soft flounce give both suits a coordinated statement look.</li>",
        "<li><strong>Black swim bottoms:</strong> Solid bottoms balance the print and keep the set easy to pair with coverups.</li>",
        "<li><strong>Mother swim skirt styling:</strong> The adult look includes a sheer tie-side skirt shown over the swim bottom.</li>",
        ...
        "</ul>",
        "",
        "<p>Choose the sizes you need and pack a matching leopard swim look that feels ready for beach days, poolside photos, and every sunny family memory.</p>",
    ]
)
...
COLOR_PATTERN_GIDS_JSON='["gid://shopify/Metaobject/69944672353","gid://shopify/Metaobject/69943132257"]'
...
METAFIELDS_JSON="$(jq -nc \
  ...
  [
      ...
      {ownerId: $pid, namespace: "custom", key: "subcategory2", type: "single_line_text_field", value: "Two-Piece Swimsuits"},
      {ownerId: $pid, namespace: "custom", key: "pattern", type: "single_line_text_field", value: "Gray Leopard"},
      ...
      {ownerId: $pid, namespace: "mm-google-shopping", key: "custom_label_1", type: "single_line_text_field", value: "Gray Leopard"},
...
for image_path in "${MEDIA_FILES[@]}"; do
  ...
  case "$image_name" in
    01-*)
      alt_text="Mother and daughter in matching gray leopard ruffle swimsuits."
      ;;
    02-*)
      alt_text="Mother wearing the gray leopard ruffle bikini with black swim bottom and sheer skirt."
      ;;
    *)
      alt_text="Girl wearing the gray leopard ruffle swimsuit with black high-waist bottom."
      ;;
  esac
...
for recap in derived["recap"]:
    ...
    put("Google Shopping / Custom Label 1", "Gray Leopard")
    ...
    put("Pattern (product.metafields.custom.pattern)", "Gray Leopard")
    put("Style (product.metafields.custom.style)", "Ruffle Bikini")
    put("SubCategory (product.metafields.custom.subcategory)", "Swimsuits")
    put("SubCategory2 (product.metafields.custom.subcategory2)", "Two-Piece Swimsuits")
    ...
    put("Color (product.metafields.shopify.color-pattern)", "Gray, Black")
...
lines.append("- The child chart is a fit-recommendation table with height, weight, and age only; unsupported garment columns stay `-` instead of being fabricated.")
lines.append("- Adult rows provide bust, waist, and hip in both cm and inches. Adult height, weight, skirt, pant, and garment length are unavailable and stay `-`.")
lines.append("- Child rows were mapped to the nearest honest DLM size labels using the vendor age/height ranges: 104 -> Child 2 Years, 116 -> Child 4 Years, 128 -> Child 5 Years, 140 -> Child 6-7 Years, 152 -> Child 9-10 Years, and 164 -> Child 12 Years.")
lines.append("- `Child 12 Years` extends the base prompt's short child mapping, but the attached chart explicitly gives a 10-12 age row and the live store exposes a truthful `shopify--size` 12 metaobject, so the row was preserved.")
lines.append("")
...
lines.append("- The size table keeps vendor recommendation data honest: child height/weight and adult bust/waist/hip use metric + imperial, and unsupported measurement columns stay `-`.")
...
lines.append("- Confirm the exact fiber composition if the vendor page becomes accessible without captcha; `shopify.fabric` is set to `Polyester` following the live swimwear precedent, but the source screenshots do not confirm fiber content.")
lines.append("- Re-check whether the supplier has garment-length or skirt-length measurements beyond the attached fit chart once the source page is accessible without captcha.")
