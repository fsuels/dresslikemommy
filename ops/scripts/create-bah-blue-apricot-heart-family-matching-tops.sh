...
{
  "root": "/Users/fsuels/Projects/dresslikemommy",
  "handle": "blue-apricot-heart-family-matching-tops",
  "title": "Blue Apricot Heart Family Matching Tops - Raglan Tee",
  "seo_title": "Blue Apricot Heart Tops | Dress Like Mommy",
  "seo_description": "Soft knit family matching raglan tops for parents and kids. Sizes Child 2Y-9-10Y and Adult S-5XL in blue apricot.",
  "print_name": "Blue Apricot Heart",
  "shortcode": "BAH",
  "color_token": "BLUE",
  "color_name": "Blue Apricot",
  ...
  "merch_style": "Raglan Heart Tee",
  "merch_type": "Top",
  "season": "Summer",
  "vendor_url": "https://detail.1688.com/offer/903638707785.html?",
  ...
  "script_path": "/Users/fsuels/Projects/dresslikemommy/ops/scripts/create-bah-blue-apricot-heart-family-matching-tops.sh",
  "upload_dir": "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-heart-family-matching-tops",
  "listing_md": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-apricot-heart-family-matching-tops-listing.md",
  "csv_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/blue-apricot-heart-family-matching-tops-shopify-import.csv",
  "verify_json_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/verify-blue-apricot-heart-family-matching-tops.json",
  "size_chart_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/size-chart-blue-apricot-heart-family-matching-tops.json",
  "body_html_out": "/Users/fsuels/Projects/dresslikemommy/ops/listings/body-blue-apricot-heart-family-matching-tops.html",
  ...
  "color_pattern_gids": [
    ...
    "gid://shopify/Metaobject/69641928801",
  ...
  "product_info": {
    ...
    "color_en": "Blue Apricot"
  },
  "fit_report": [],
  "product_image_sources": [
    "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-heart-family-matching-tops/look-1.png",
    "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-heart-family-matching-tops/look-2.png"
  ],
  "size_chart_source": "/Users/fsuels/Projects/dresslikemommy/ops/listings/source-blue-apricot-heart-family-matching-tops-size-chart.png",
  "required_tags": [
    "Family Matching",
    "Tops",
    ...
    "Child 8 Years",
    "Child 9-10 Years",
    "https://detail.1688.com/offer/903638707785.html?"
  ]
}
JSON
)
...
[
  ...
  {"audience":"adult","role":"Adult Top","garment":"Top","vendor_label":"5XL/195","picker_label":"Adult 5XL","sku_suffix":"5XL","age":"—","weight":"100-110 kg","height":"195-200 cm","chest_cm":124,"hip_cm":124,"waist_cm":112,"length_cm":77,"shoulder_cm":56,"sleeve_cm":22.5,"pant_cm":0}
]
JSON
)
...
mkdir -p "${ROOT}/ops/listings" "/Users/fsuels/Projects/dresslikemommy/uploads/blue-apricot-heart-family-matching-tops"
...
size_phrase = "Child 2Y-9-10Y and Adult S-5XL"
size_range_copy = "Children 2Y through 9-10Y and adults S through 5XL"
...
body_html = "\n".join(
    [
        ...
        "<li><strong>Print reference:</strong> Blue Apricot Heart pairs a warm apricot body with navy sleeves, a red crew neckline, and a cheerful Smile graphic layered over a golden heart.</li>",
        "<li><strong>Design details:</strong> Short raglan sleeves, contrast neck trim, relaxed tee shape, and matching Smile-and-heart artwork across the family tops. The denim shorts and pants shown in the photos are styling only and not included.</li>",
        ...
        *table_rows,
        ...
        "</table>",
        "",
        "<p>Blue Apricot Heart keeps matching family style easy and bright with one relaxed tee silhouette across kids and adults. The navy raglan sleeves, apricot body, and red neckline make the set feel coordinated without being too formal, while the Smile-and-heart artwork gives each family member a playful photo-ready detail.</p>",
        "",
        "<p>The attached chart publishes top measurements for child sizes 90-150 and adult sizes S-5XL. The two infant rows labeled as rompers were excluded from this Tops listing, and the denim bottoms in the images are styling only. The published variants therefore stay tightly tied to the vendor-backed top rows.</p>",
        "",
        "<h3>Key Features:</h3>",
        "<ul>",
        "<li><strong>Coordinated raglan tee:</strong> Matching short-sleeve top for kids and adults in the same apricot, navy, and red palette.</li>",
        "<li><strong>Family-friendly graphic:</strong> Each top carries the same Smile-and-heart artwork for a sweet matching moment.</li>",
        "<li><strong>Easy warm-weather styling:</strong> The relaxed tee shape pairs naturally with denim shorts, jeans, skirts, or casual vacation outfits.</li>",
        "<li><strong>Wide adult size range:</strong> Adult sizing runs from S through 5XL based on the attached chart.</li>",
...
if existing_product is None:
    for legacy_handle in settings.get("legacy_handles", []):
        legacy_data = gql(
            """
            query ExistingProduct($handle: String!) {
              productByHandle(handle: $handle) {
        ...
        existing_product = legacy_data["data"]["productByHandle"]
...
metafields = [
    ...
    {"ownerId": product_id, "namespace": "mm-google-shopping", "key": "custom_label_3", "type": "single_line_text_field", "value": "Raglan Heart Tee"},
...
alt_by_name = {
    "look-1.png": "Blue apricot family matching raglan tops with Smile-and-heart graphics.",
    "look-2.png": "Parents and child wearing the blue apricot Smile family matching raglan tops outdoors.",
}

desired_media_alts = set(alt_by_name.values())
stale_media_ids = [
    item["id"]
    for item in existing_media
    if (item.get("alt") or "") not in desired_media_alts
]
if stale_media_ids:
    delete_media = gql(
        """
        ...
        """,
        {"productId": product_id, "mediaIds": stale_media_ids},
    )
    user_errors = delete_media["data"]["productDeleteMedia"]["userErrors"]
    if user_errors:
        raise RuntimeError(f"productDeleteMedia userErrors: {json.dumps(user_errors, ensure_ascii=False)}")
    stale_media_id_set = set(stale_media_ids)
    existing_media = [item for item in existing_media if item["id"] not in stale_media_id_set]
    existing_media_alts = {item.get("alt") or "" for item in existing_media}
...
for index, row in enumerate(recap, start=1):
    ...
    record["Google Shopping / Custom Label 3"] = "Raglan Heart Tee"
    ...
    record["Color (product.metafields.shopify.color-pattern)"] = "Blue, Beige, Red"
...
metafield_lines = [
    ...
    "- mm-google-shopping.custom_label_3 = `Raglan Heart Tee`",
