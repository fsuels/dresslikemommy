...
test('all 21 locale files change only the six scoped return keys', () => {
...
test('inactive locale parity adds only the two keys and all 35 locale files contain them', () => {
