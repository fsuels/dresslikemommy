...
const theme = readFileSync(new URL('./theme/layout/theme.liquid', import.meta.url), 'utf8');
...
const footer = readFileSync(new URL('./theme/sections/footer.liquid', import.meta.url), 'utf8');
const footerScript = readFileSync(new URL('./theme/assets/cookie-preferences.js', import.meta.url), 'utf8');
...
test('both preferences messages exist in all 35 theme locales, including the 21 published locales', () => {
  const localeFiles = readdirSync(new URL('./theme/locales/', import.meta.url))
  ...
  for (const locale of localeFiles) {
    const source = readFileSync(new URL(`./theme/locales/${locale}`, import.meta.url), 'utf8');
