...
out=O/'proposed_language_mappings_v2.json';out.write_text(json.dumps({'status':'AUTHOR_PROPOSED_MAPPING_ONLY_PENDING_ROOT_INDEPENDENT_MEANING_REVIEW','rows':output},ensure_ascii=False,indent=2)+'\n')
