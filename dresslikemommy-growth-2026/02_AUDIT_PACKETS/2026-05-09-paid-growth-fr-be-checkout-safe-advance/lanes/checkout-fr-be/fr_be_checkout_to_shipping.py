#!/usr/bin/env python3
"""FR/BE isolated-browser checkout-to-shipping QA.
...
SUMMARY_PATH = LANE_DIR / "fr_be_checkout_to_shipping_summary.json"
REPORT_PATH = LANE_DIR / "FR_BE_CHECKOUT_TO_SHIPPING.md"
...
def build_summary(client: CdpClient, country_code: str) -> dict[str, Any]:
    ...
    return {
        ...
        "lane": "FR/BE isolated-browser checkout-to-shipping QA",
        "country_code": country_code,
        "problem_id": "PROB-2026-05-09-FR-BE-CHECKOUT-QA",
...
def main() -> None:
    ...
    parser.add_argument("--countries", nargs="+", choices=sorted(MARKETS), default=["FR", "BE"])
