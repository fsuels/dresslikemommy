...
| `semantically_relevant_anchor` | `true` | names the unique retrieved anchor 2026-09-07-ceo-turnaround-meow-search-identity |
...
| `task_stage_matches_retrieved_anchor` | `true` | task_stage matches VERIFY |
