...
var UI_LABELS_BY_LOCALE = {
  ...
  cs: {
    ...
    chooseRoleStep: "Vyberte, pro koho je tento kus",
    chooseOptionsStep: "Vyberte velikost a možnosti",
    chooseRoleCta: "Vyberte člena rodiny",
    addCurrentPiece: "Přidat tento kus do košíku",
    readyToAdd: "Připraveno k přidání",
  },
  da: {
  ...
  de: {
    ...
    chooseRoleStep: "Wähle, für wen dieses Teil ist",
    chooseOptionsStep: "Wähle Größe und Optionen",
    chooseRoleCta: "Wähle ein Familienmitglied",
    addCurrentPiece: "Dieses Teil in den Warenkorb",
  ...
  el: {
    ...
    chooseRoleStep: "Επιλέξτε για ποιον είναι αυτό το κομμάτι",
    chooseOptionsStep: "Επιλέξτε μέγεθος και επιλογές",
    chooseRoleCta: "Επιλέξτε μέλος της οικογένειας",
    addCurrentPiece: "Προσθήκη αυτού του κομματιού στο καλάθι",
    readyToAdd: "Έτοιμο για προσθήκη",
  },
  es: {
    ...
    chooseRoleCta: "Elige un familiar",
    addCurrentPiece: "Añadir esta pieza al carrito",
    readyToAdd: "Listo para añadir",
  },
  fr: {
    ...
    chooseRoleStep: "Choisissez à qui cette pièce est destinée",
    chooseOptionsStep: "Choisissez la taille et les options",
    chooseRoleCta: "Choisissez un membre de la famille",
    addCurrentPiece: "Ajouter cette pièce au panier",
    readyToAdd: "Prête à être ajoutée",
  },
  it: {
    ...
    chooseRoleStep: "Scegli per chi è questo capo",
    chooseOptionsStep: "Scegli taglia e opzioni",
    chooseRoleCta: "Scegli un familiare",
    addCurrentPiece: "Aggiungi questo capo al carrello",
    readyToAdd: "Pronto da aggiungere",
  },
  nl: {
    ...
    chooseRoleStep: "Kies voor wie dit kledingstuk is",
    chooseOptionsStep: "Kies de maat en opties",
    chooseRoleCta: "Kies een gezinslid",
    addCurrentPiece: "Dit kledingstuk in de winkelwagen",
    readyToAdd: "Klaar om toe te voegen",
  },
  pl: {
    ...
    chooseRoleStep: "Wybierz, dla kogo jest ta część stroju",
    chooseOptionsStep: "Wybierz rozmiar i opcje",
    chooseRoleCta: "Wybierz członka rodziny",
    addCurrentPiece: "Dodaj tę część stroju do koszyka",
    readyToAdd: "Gotowe do dodania",
  },
  pt: {
    ...
    customerPhotos: 'Fotos de clientes',
    chooseRoleStep: "Escolha para quem é esta peça",
    chooseOptionsStep: "Escolha o tamanho e as opções",
    chooseRoleCta: "Escolha um familiar",
    addCurrentPiece: "Adicionar esta peça ao carrinho",
    readyToAdd: "Pronto para adicionar",
  },
  ro: {
    ...
    chooseRoleStep: "Alege pentru cine este această piesă",
    chooseOptionsStep: "Alege mărimea și opțiunile",
    chooseRoleCta: "Alege un membru al familiei",
    addCurrentPiece: "Adaugă această piesă în coș",
    readyToAdd: "Gata de adăugat",
  },
  sv: {
    ...
    chooseRoleStep: "Välj vem det här plagget är till",
    chooseOptionsStep: "Välj storlek och alternativ",
    chooseRoleCta: "Välj en familjemedlem",
    addCurrentPiece: "Lägg det här plagget i varukorgen",
    readyToAdd: "Redo att läggas i varukorgen",
  },
  ar: {
    ...
    chooseRoleStep: "Valitse, kenelle tämä vaate on",
    chooseOptionsStep: "Valitse koko ja vaihtoehdot",
    chooseRoleCta: "Valitse perheenjäsen",
    addCurrentPiece: "Lisää tämä vaate ostoskoriin",
    readyToAdd: "Valmis lisättäväksi",
  },
  he: {
    chooseRoleStep: "בחרו למי מיועד הפריט",
    chooseOptionsStep: "בחרו מידה ואפשרויות",
    chooseRoleCta: "בחרו בן או בת משפחה",
    addCurrentPiece: "הוספת הפריט לסל",
    readyToAdd: "מוכן להוספה",
  },
  hi: {
    chooseRoleStep: "चुनें कि यह कपड़ा किसके लिए है",
    chooseOptionsStep: "साइज़ और विकल्प चुनें",
    chooseRoleCta: "परिवार का सदस्य चुनें",
    addCurrentPiece: "यह कपड़ा कार्ट में जोड़ें",
    readyToAdd: "जोड़ने के लिए तैयार",
  },
  ja: {
    chooseRoleStep: "この服を着る方を選んでください",
    chooseOptionsStep: "サイズとオプションを選んでください",
    chooseRoleCta: "着る方を選んでください",
    addCurrentPiece: "この商品をカートに追加",
    readyToAdd: "カートに追加できます",
  },
  ko: {
    chooseRoleStep: "이 옷을 입을 가족을 선택하세요",
    chooseOptionsStep: "사이즈와 옵션을 선택하세요",
    chooseRoleCta: "가족 구성원을 선택하세요",
    addCurrentPiece: "이 상품을 장바구니에 담기",
    readyToAdd: "장바구니에 담을 수 있어요",
  },
  no: {
    chooseRoleStep: "Velg hvem dette plagget er til",
    chooseOptionsStep: "Velg størrelse og alternativer",
    chooseRoleCta: "Velg et familiemedlem",
    addCurrentPiece: "Legg dette plagget i handlekurven",
    readyToAdd: "Klart til å legges i handlekurven",
  },
  ru: {
    chooseRoleStep: "Выберите, для кого эта вещь",
    chooseOptionsStep: "Выберите размер и параметры",
    chooseRoleCta: "Выберите члена семьи",
    addCurrentPiece: "Добавить эту вещь в корзину",
    readyToAdd: "Готово к добавлению",
  },
};
...
var ROLE_DEFINITIONS = [
  ...
  },
  {
    ...
    aliases: ['child', 'children', 'kid', 'kids', 'infantil', 'enfant', 'enfants', 'infant', 'kind', 'kinder', 'bambini', 'barn', 'dziecko', 'dzieci', 'dítě', 'детский', 'ребенок', 'ребёнок', '儿童', '兒童', '子供', '아동', 'ילדים', 'बच्चा', 'طفل', 'الطفل', 'أطفال', 'اطفال', 'للأولاد'],
  },
  {
    key: 'baby',
    label: 'Baby',
...
function getRoleInfoForVariant(variant, options, sizeOptionIndex) {
  ...
  if (skuRoleKey && skuRoleKey !== 'child') {
...
function initMatchingSetBuilder(wrapper, sectionId, productData) {
  ...
  // Source: every size-chart table in the product copy. Multi-role
  // listings often split Dress vs Shirt tables or put Mom/Dad/Girl/Boy
  // measurements in header groups, so the lookup keeps role/table context
  // instead of treating the first chart row as globally correct.
  // ─────────────────────────────────────────────────────────────────────
  ...
  function getMeasurementRoleKeysFromText(text) {
    ...
    ROLE_DEFINITIONS.forEach(function (roleDefinition) {
      ...
      if (matched && roles.indexOf(roleDefinition.key) === -1) roles.push(roleDefinition.key);
    });
  ...
  function comparableSizeTokens(value) {
    ...
    var text = normalizeText((parsedRole && parsedRole.sizeLabel) || value)
      .replace(/[\u2013\u2014]/g, '-')
    ...
    if (adult) {
      ...
      adultToken = { xxl: '2xl', xxxl: '3xl', xxxxl: '4xl' }[adultToken] || adultToken;
    ...
    if (month) {
      ...
      add('month:' + monthValue + 'm');
      if (monthValue && monthValue % 12 === 0) {
        var yearFromMonth = monthValue / 12;
        add('age-max:' + yearFromMonth);
        add('toddler:' + yearFromMonth + 't');
      }
    }
    ...
    if (ageRange) {
      ...
      var ageMax = Number(ageRange[2]);
      if (ageMin > 0 && ageMin <= ageMax && ageMax <= 20) {
        add('age-min:' + ageMin);
        add('age-max:' + ageMax);
    ...
    if (height && Number(height[1]) >= 80) add('height-max:' + Number(height[1]));
    ...
    if (numbers && numbers.length) {
      add(
        'n:' +
          numbers
            .map(function (number) {
              return number.replace(',', '.').replace(/\.0+$/, '').replace(/(\.\d*?)0+$/, '$1');
            })
            .join('-')
      );
    }
  ...
  function adultSizeRank(token) {
    var ranks = { xs: 1, s: 2, m: 3, l: 4, xl: 5, '2xl': 6, '3xl': 7, '4xl': 8 };
  ...
  function sizeTokenMatchRank(selectedTokens, rowTokens) {
    ...
    var row = rowTokens || [];
    var selectedLookup = {};
    for (var i = 0; i < selected.length; i += 1) selectedLookup[selected[i]] = true;
    for (var j = 0; j < row.length; j += 1) {
      if (selectedLookup[row[j]]) return 1;
    }

    var selectedAdults = selected.filter(function (token) { return token.indexOf('adult:') === 0; });
    var rowAdults = row.filter(function (token) { return token.indexOf('adult:') === 0; });
    if (selectedAdults.length || rowAdults.length) {
      var selectedAdultRanks = selectedAdults
        .map(function (token) { return adultSizeRank(token.split(':', 2)[1]); })
        .filter(function (rank) { return rank !== null; });
      var rowAdultRanks = rowAdults
        .map(function (token) { return adultSizeRank(token.split(':', 2)[1]); })
        .filter(function (rank) { return rank !== null; });
      if (!selectedAdultRanks.length || !rowAdultRanks.length) return 0;
      return selectedAdultRanks.some(function (selectedRank) {
    ...
    var selectedAges = numericTokenValues(selected, 'age-max:').concat(numericTokenValues(selected, 'toddler:'));
    var rowAges = numericTokenValues(row, 'age-max:').concat(numericTokenValues(row, 'toddler:'));
    if (
      selectedAges.length &&
      rowAges.length &&
    ...
    var rowHeights = numericTokenValues(row, 'height-max:');
    if (
  ...
  function roleKeysCompatible(selectedRoleKey, entryRoleKey) {
    if (!selectedRoleKey || !entryRoleKey || selectedRoleKey === entryRoleKey) return true;
    if (selectedRoleKey === 'child' && ['girl', 'boy', 'baby'].indexOf(entryRoleKey) !== -1) return true;
    if (selectedRoleKey === 'adult' && ['mother', 'father'].indexOf(entryRoleKey) !== -1) return true;
    if (entryRoleKey === 'child' && ['girl', 'boy', 'baby'].indexOf(selectedRoleKey) !== -1) return true;
    if (entryRoleKey === 'adult' && ['mother', 'father'].indexOf(selectedRoleKey) !== -1) return true;
    return false;
  }

  function garmentKeysCompatible(selectedGarmentKey, entryGarmentKey) {
    if (!selectedGarmentKey || !entryGarmentKey || selectedGarmentKey === entryGarmentKey) return true;
    var shirtFamily = ['shirt', 'shorts', 'shirtShortsSet'];
    return shirtFamily.indexOf(selectedGarmentKey) !== -1 && shirtFamily.indexOf(entryGarmentKey) !== -1;
  }
  ...
  function inferBaseRoleKeyFromMeasurementSize(sizeLabel) {
    ...
    if (tokens.some(function (token) { return token.indexOf('adult:') === 0; })) return 'adult';
    if (
  ...
  function pruneMeasurementsForRole(roleKey, headers, row, garmentKey) {
    ...
    if (!pruned.rows.length || !pruned.rows[0].slice(1).some(function (value) { return !isGuideEmptyValue(value); })) {
      return null;
    }
  ...
  function addSizeMeasurementEntry(lookup, roleKey, garmentKey, label, headers, row) {
    ...
    if (entry.roleKey && entry.garmentKey) {
  ...
  function addPrunedSizeMeasurementEntries(lookup, roleKey, contextGarmentKey, label, headers, row) {
    if (contextGarmentKey) {
      var tableMeasurements = pruneMeasurementsForRole(roleKey, headers, row, '');
  ...
  function getExplicitLandingVariant() {
  ...
  function getCurrentPiecePrompt(activeGroup) {
    ...
    var selectedOption = resolveVariantInGroup(activeGroup, activeInstance.sizeLabel, selections);
  ...
  function getSelectedItems() {
    ...
    instances.forEach(function (inst) {
      ...
      if (!group || !option || option.available === false) return;
      items.push({
  ...
  function getDisplayedMatchingVariant() {
  ...
  function getDefaultGroupForBootstrap(groups) {
    // First page load: surface one role immediately so size options are
    // visible without a preliminary role click. Prefer adults in the
    // expected shopping order, then fall back to children/first group.
    var priorities = ['mother', 'father', 'adult', 'girl', 'boy', 'child', 'baby'];
