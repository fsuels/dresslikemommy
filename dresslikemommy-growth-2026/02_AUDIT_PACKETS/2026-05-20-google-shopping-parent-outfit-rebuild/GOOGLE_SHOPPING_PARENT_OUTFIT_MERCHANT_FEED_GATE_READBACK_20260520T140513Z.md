...
UTC timestamp: `20260520T140513Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `4382`
- Live rows matching expected item IDs: `4382`
- Missing expected rows: `149`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T140513Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T140513Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T140513Z.csv`
