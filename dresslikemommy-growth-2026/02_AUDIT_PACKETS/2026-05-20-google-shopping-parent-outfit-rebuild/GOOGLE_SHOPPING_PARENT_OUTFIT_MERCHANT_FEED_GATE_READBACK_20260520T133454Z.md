...
UTC timestamp: `20260520T133454Z`
...
- Rows with old `paid_eligible` + `us_test_ready`: `344`
- Old-label rows matching the new expected item IDs: `230`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T133454Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T133454Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T133454Z.csv`
