...
UTC timestamp: `20260520T125915Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `541`
- Live rows matching expected item IDs: `541`
- Missing expected rows: `3990`
- Unexpected ready-label rows: `0`
- Live parent counts by lane from spec join: `{'daddy_and_me': 25, 'family_matching': 70, 'mommy_and_me': 63}`
- Label mismatches: `0`
- Image mismatches: `0`
...
- Rows with old `paid_eligible` + `us_test_ready`: `708`
- Old-label rows matching the new expected item IDs: `594`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T125915Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T125915Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T125915Z.csv`
