...
UTC timestamp: `20260521T145651Z`
...
- Ready-label rows: `4392`
- Present non-ready-label rows: `68`
...
- Issue severity counts: `{'WARNING': 3428, 'ERROR': 4480}`
- Attribute issue counts: `{'age group|missing_item_attribute_for_product_type': 2030, 'color|missing_item_attribute_for_product_type': 1049, 'gender|missing_item_attribute_for_product_type': 343, 'size|missing_item_attribute_for_product_type': 6}`
...
- Present non-ready parent rows: `[{'parent_product_id': '6718948147297', 'handle': 'matching-mom-child-one-shoulder-swimsuit', 'lane': 'mommy_and_me', 'present_non_ready_variants': 40}, {'parent_product_id': '6719764463713', 'handle': 'matching-mommy-and-me-hollow-out-bikini', 'lane': 'mommy_and_me', 'present_non_ready_variants': 10}, {'parent_product_id': '6719792873569', 'handle': 'matching-mommy-me-sunflower-print-swimsuit', 'lane': 'mommy_and_me', 'present_non_ready_variants': 10}, {'parent_product_id': '7535944368225', 'handle': 'powder-blue-mommy-and-me-set', 'lane': 'mommy_and_me', 'present_non_ready_variants': 6}, {'parent_product_id': '7227254276193', 'handle': 'mommy-and-me-matching-yellow-sleeveless-maxi-dress-vibrant-summer-beach-dress-for-mother-daughter', 'lane': 'mommy_and_me', 'present_non_ready_variants': 2}]`
...
- JSON: `google_shopping_parent_outfit_eligibility_diagnostic_20260521T145651Z.json`
- Present rows CSV: `google_shopping_parent_outfit_eligibility_present_rows_20260521T145651Z.csv`
- Missing rows CSV: `google_shopping_parent_outfit_eligibility_missing_rows_20260521T145651Z.csv`
