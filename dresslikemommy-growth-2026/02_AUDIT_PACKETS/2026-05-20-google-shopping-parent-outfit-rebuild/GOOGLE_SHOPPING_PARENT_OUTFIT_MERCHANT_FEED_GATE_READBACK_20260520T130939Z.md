...
UTC timestamp: `20260520T130939Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `1132`
- Live rows matching expected item IDs: `1132`
- Missing expected rows: `3399`
...
- Rows with old `paid_eligible` + `us_test_ready`: `626`
- Old-label rows matching the new expected item IDs: `512`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T130939Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T130939Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T130939Z.csv`
