...
UTC timestamp: `20260520T104330Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `145`
- Live rows matching expected item IDs: `145`
- Missing expected rows: `4386`
- Unexpected ready-label rows: `0`
- Live parent counts by lane from spec join: `{'family_matching': 6, 'mommy_and_me': 5}`
- Label mismatches: `0`
- Image mismatches: `0`
...
- Rows with old `paid_eligible` + `us_test_ready`: `754`
- Old-label rows matching the new expected item IDs: `640`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T104330Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T104330Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T104330Z.csv`
