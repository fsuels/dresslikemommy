...
UTC timestamp: `20260520T131851Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `1835`
- Live rows matching expected item IDs: `1835`
- Missing expected rows: `2696`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T131851Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T131851Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T131851Z.csv`
