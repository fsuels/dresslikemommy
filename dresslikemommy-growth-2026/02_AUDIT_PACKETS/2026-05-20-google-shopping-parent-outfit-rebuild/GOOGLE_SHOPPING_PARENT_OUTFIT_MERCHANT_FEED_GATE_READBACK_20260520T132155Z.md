...
UTC timestamp: `20260520T132155Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `1886`
- Live rows matching expected item IDs: `1886`
- Missing expected rows: `2645`
...
- Rows with old `paid_eligible` + `us_test_ready`: `506`
- Old-label rows matching the new expected item IDs: `392`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T132155Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T132155Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T132155Z.csv`
