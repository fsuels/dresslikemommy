...
UTC timestamp: `20260521T101106Z`
...
- Live rows with `custom_label_4=us_parent_outfit_ready_v20260520`: `4391`
- Live rows matching expected item IDs: `4391`
- Missing expected rows: `140`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260521T101106Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260521T101106Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260521T101106Z.csv`
