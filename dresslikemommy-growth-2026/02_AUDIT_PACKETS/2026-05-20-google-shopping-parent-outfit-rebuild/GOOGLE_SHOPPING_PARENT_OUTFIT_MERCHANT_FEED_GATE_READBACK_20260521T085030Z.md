...
UTC timestamp: `20260521T085030Z`
...
The paused V2 campaign shells remain safe, labels and images are clean on the ready rows, and the ready-label count has stabilized at `4,390`. The Merchant/feed product gate still fails closed because `141` expected offer rows are missing from the live Shopping-product surface. Do not activate or discuss activation until a separate approved missing-offer/primary-source repair and after-state readback proves the full count, parent counts, hero images, and item grouping live.

## Output Files

- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260521T085030Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260521T085030Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260521T085030Z.csv`
