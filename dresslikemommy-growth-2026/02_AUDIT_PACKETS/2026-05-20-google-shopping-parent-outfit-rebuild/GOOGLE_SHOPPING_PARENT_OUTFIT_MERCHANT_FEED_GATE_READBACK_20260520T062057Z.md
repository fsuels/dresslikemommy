...
UTC timestamp: `20260520T062057Z`
...
- Live rows matching expected item IDs: `0`
- Missing expected rows: `4531`
- Unexpected ready-label rows: `0`
- Live parent counts by lane from spec join: `{}`
- Label mismatches: `0`
- Image mismatches: `0`
...
- JSON: `google_shopping_parent_outfit_merchant_feed_gate_20260520T062057Z.json`
- Ready products CSV: `google_shopping_parent_outfit_ready_products_20260520T062057Z.csv`
- Old-label context CSV: `google_shopping_parent_outfit_old_us_test_ready_products_20260520T062057Z.csv`
